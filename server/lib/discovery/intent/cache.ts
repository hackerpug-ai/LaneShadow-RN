 ...
 */
export async function bumpHitCount(db: DiscoveryDB, normalizedIntent: string): Promise<void> {
  await db.runAsync(
 ...
 */
export async function topHitIntents(db: DiscoveryDB, limit: number): Promise<string[]> {
