...
**Sprint**: `.spec/epic-1/sprints/sprint-3/spec.md`
**Source of truth**: `.spec/epic-1/TRD.md`
**Sprint 2 handoff (what already exists)**: `.spec/epic-1/sprints/sprint-2/handoff.md`
...
#### Requirements
- Write a short manual verification checklist (recommend appending to `convex/README.md` or `.spec/epic-1/sprints/sprint-3/spec.md`):
...
#### Files to Modify
- `convex/README.md` (preferred) and/or `.spec/epic-1/sprints/sprint-3/spec.md`
