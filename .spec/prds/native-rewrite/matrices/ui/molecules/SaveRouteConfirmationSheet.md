...
# STYLE PROPERTIES MATRIX — SaveRouteConfirmationSheet

## Component Overview

**RN Source:** `react-native/components/sheets/save-route-confirmation-sheet.tsx`  
**Atomic Level:** Molecule  
**Domain:** UI Component

### Description

Confirmation for saving routes.
