...
# STYLE PROPERTIES MATRIX — EnrichmentStatusIndicator

## Component Overview

**RN Source:** `react-native/components/planning/enrichment-status-indicator.tsx`  
**Atomic Level:** Molecule  
**Domain:** UI Component

### Description

Status for route enrichment.
