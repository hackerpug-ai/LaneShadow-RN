...
**Level:** Screen
**Source:** `react-native/components/setup/ModelDownloadScreen.tsx`
...
|---|---|---|---|---|
| Layout | `react-native/components/setup/ModelDownloadScreen.tsx` | `react-native/Libraries/Components/View/View.js` | Android: `app/src/main/java/com/laneshadow/ui/screens/ModelDownloadScreen.kt`<br>iOS: `app/ui/screens/ModelDownloadScreen.swift` | 2 states: downloading, complete |
...
**Source files read:**
- LaneShadow: `react-native/components/setup/ModelDownloadScreen.tsx`
...
| Category | Property | Source | Value in source | Android equivalent | iOS equivalent | Token mapping |
|---|---|---|---|---|---|---|
| Typography | variant | RN-wrapper | `bodyLarge` (Paper) | `MaterialTheme.typography.bodyLarge` | `.font(.bodyLarge)` | semantic.type.body.md |
...
- Dedicated screen for model download
- Shows progress bar
- Shows percentage
...
- ModelDownloadScreen = Column + [Progress, Text, Button]
