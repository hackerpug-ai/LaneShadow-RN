================================================================================
TASK: UI-023 - SheetHandle (Android)
================================================================================
...
Implement SheetHandle component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/SheetHandle.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/SheetHandleTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: SheetHandle is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: SheetHandleTest.kt
  TEST_FUNCTION: testSheetHandleDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: SheetHandleTest.kt
  TEST_FUNCTION: testSheetHandleStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: SheetHandleTest.kt
  TEST_FUNCTION: testSheetHandleStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/atoms/SheetHandle.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/sheethandle.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/SheetHandle.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/SheetHandleTest.kt (NEW)
...
**Current state:** SheetHandle exists as React Native wrapper
...
1. READ matrices/ui/atoms/SheetHandle.md for complete style properties
