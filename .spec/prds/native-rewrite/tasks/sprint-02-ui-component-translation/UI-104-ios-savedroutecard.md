================================================================================
TASK: UI-104 - SavedRouteCard (Ios)
================================================================================
...
Implement SavedRouteCard component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/SavedRouteCard.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: SavedRouteCardTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/SavedRouteCard.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/SavedRouteCardTests.swift (NEW)
