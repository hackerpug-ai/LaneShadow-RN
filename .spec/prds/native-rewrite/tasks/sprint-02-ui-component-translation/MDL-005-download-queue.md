================================================================================
TASK: MDL-005 - DownloadQueue Model Translation
================================================================================
...
Translate download-queue model/logic from TypeScript to Kotlin following the MODEL translation plan.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/models/DownloadQueue.kt (NEW): Kotlin implementation
- react-native/android/app/src/test/java/com/laneshadow/models/DownloadQueueTest.kt (NEW): Model tests
...
AC-1: Public API matches source
  ...
  TEST_FILE: DownloadQueueTest.kt
...
1. matrices/models/MODEL-download-queue.md
   - Lines: ALL
   - Focus: SOURCE ANALYSIS and TRANSLATION STRATEGY

2. react-native/lib/download-queue.ts
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/models/DownloadQueue.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/models/DownloadQueueTest.kt (NEW)

WRITE-PROHIBITED:
- matrices/** — read-only references
- react-native/lib/download-queue.ts (MODIFY) — source is reference only

MUST:
- [ ] Follow translation strategy from MODEL-download-queue.md
...
**Current state:** download-queue exists as TypeScript module
...
1. READ matrices/models/MODEL-download-queue.md for complete translation strategy
...
Depends On:
- FND-006 — MODEL-download-queue.md translation plan complete
