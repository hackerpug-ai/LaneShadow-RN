================================================================================
TASK: UI-092 - RegionNameBottomSheet (Android)
================================================================================
...
Implement RegionNameBottomSheet component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RegionNameBottomSheet.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RegionNameBottomSheetTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: RegionNameBottomSheet is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RegionNameBottomSheetTest.kt
  TEST_FUNCTION: testRegionNameBottomSheetDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RegionNameBottomSheetTest.kt
  TEST_FUNCTION: testRegionNameBottomSheetStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RegionNameBottomSheetTest.kt
  TEST_FUNCTION: testRegionNameBottomSheetStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/RegionNameBottomSheet.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/regionnamebottomsheet.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/RegionNameBottomSheet.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RegionNameBottomSheetTest.kt (NEW)
...
**Current state:** RegionNameBottomSheet exists as React Native wrapper
...
1. READ matrices/ui/molecules/RegionNameBottomSheet.md for complete style properties
