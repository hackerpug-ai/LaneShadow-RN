...
Implement ReasoningCard component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/ReasoningCard.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: ReasoningCardTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/ReasoningCard.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/ReasoningCardTests.swift (NEW)
