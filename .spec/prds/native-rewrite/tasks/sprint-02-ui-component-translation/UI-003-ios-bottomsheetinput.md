================================================================================
TASK: UI-003 - BottomSheetInput (Ios)
================================================================================
...
Implement BottomSheetInput component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/BottomSheetInput.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: BottomSheetInputTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/BottomSheetInput.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/BottomSheetInputTests.swift (NEW)
