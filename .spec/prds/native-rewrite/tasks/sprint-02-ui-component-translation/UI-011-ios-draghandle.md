...
Implement DragHandle component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/DragHandle.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: DragHandleTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/DragHandle.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/DragHandleTests.swift (NEW)
