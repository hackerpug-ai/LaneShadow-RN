...
Implement DrawerMenu component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/DrawerMenu.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: DrawerMenuTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/DrawerMenu.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/DrawerMenuTests.swift (NEW)
