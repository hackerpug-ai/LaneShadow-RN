================================================================================
TASK: UI-048 - DiscoverySortToggle (Android)
================================================================================
...
Implement DiscoverySortToggle component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/DiscoverySortToggle.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/DiscoverySortToggleTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: DiscoverySortToggle is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: DiscoverySortToggleTest.kt
  TEST_FUNCTION: testDiscoverySortToggleDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: DiscoverySortToggleTest.kt
  TEST_FUNCTION: testDiscoverySortToggleStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: DiscoverySortToggleTest.kt
  TEST_FUNCTION: testDiscoverySortToggleStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/DiscoverySortToggle.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/discoverysorttoggle.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/DiscoverySortToggle.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/DiscoverySortToggleTest.kt (NEW)
...
**Current state:** DiscoverySortToggle exists as React Native wrapper
...
1. READ matrices/ui/molecules/DiscoverySortToggle.md for complete style properties
