================================================================================
TASK: UI-055 - ErrorToast (Android)
================================================================================
...
Implement ErrorToast component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/ErrorToast.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/ErrorToastTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: ErrorToast is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ErrorToastTest.kt
  TEST_FUNCTION: testErrorToastDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ErrorToastTest.kt
  TEST_FUNCTION: testErrorToastStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ErrorToastTest.kt
  TEST_FUNCTION: testErrorToastStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/ErrorToast.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/errortoast.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/ErrorToast.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/ErrorToastTest.kt (NEW)
...
**Current state:** ErrorToast exists as React Native wrapper
...
1. READ matrices/ui/molecules/ErrorToast.md for complete style properties
