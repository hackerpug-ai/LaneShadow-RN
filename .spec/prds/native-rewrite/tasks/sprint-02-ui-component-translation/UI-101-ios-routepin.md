...
Implement RoutePin component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RoutePin.kt (NEW): SwiftUI implementation
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/RoutePin.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/RoutePinTests.swift (NEW)
