...
Implement AppHeader component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/AppHeader.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: AppHeaderTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/AppHeader.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/AppHeaderTests.swift (NEW)
