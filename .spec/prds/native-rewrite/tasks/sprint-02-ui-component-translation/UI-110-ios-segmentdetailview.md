================================================================================
TASK: UI-110 - SegmentDetailView (Ios)
================================================================================
...
Implement SegmentDetailView component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/SegmentDetailView.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: SegmentDetailViewTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/SegmentDetailView.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/SegmentDetailViewTests.swift (NEW)
