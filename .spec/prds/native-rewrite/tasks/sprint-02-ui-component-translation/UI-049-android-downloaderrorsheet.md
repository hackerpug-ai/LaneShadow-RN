================================================================================
TASK: UI-049 - DownloadErrorSheet (Android)
================================================================================
...
Implement DownloadErrorSheet component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/DownloadErrorSheet.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/DownloadErrorSheetTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  TEST_FILE: DownloadErrorSheetTest.kt
  TEST_FUNCTION: testDownloadErrorSheetDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: DownloadErrorSheetTest.kt
  TEST_FUNCTION: testDownloadErrorSheetStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: DownloadErrorSheetTest.kt
  TEST_FUNCTION: testDownloadErrorSheetStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/DownloadErrorSheet.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/downloaderrorsheet.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/DownloadErrorSheet.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/DownloadErrorSheetTest.kt (NEW)
...
**Current state:** DownloadErrorSheet exists as React Native wrapper
...
1. READ matrices/ui/molecules/DownloadErrorSheet.md for complete style properties
