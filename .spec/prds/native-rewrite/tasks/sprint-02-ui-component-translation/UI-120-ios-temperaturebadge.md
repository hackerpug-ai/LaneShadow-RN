================================================================================
TASK: UI-120 - TemperatureBadge (Ios)
================================================================================
...
Implement TemperatureBadge component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/TemperatureBadge.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: TemperatureBadgeTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/TemperatureBadge.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/TemperatureBadgeTests.swift (NEW)
