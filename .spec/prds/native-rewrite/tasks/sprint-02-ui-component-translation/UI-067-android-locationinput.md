================================================================================
TASK: UI-067 - LocationInput (Android)
================================================================================
...
Implement LocationInput component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/LocationInput.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/LocationInputTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: LocationInput is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: LocationInputTest.kt
  TEST_FUNCTION: testLocationInputDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: LocationInputTest.kt
  TEST_FUNCTION: testLocationInputStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: LocationInputTest.kt
  TEST_FUNCTION: testLocationInputStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/LocationInput.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/locationinput.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/LocationInput.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/LocationInputTest.kt (NEW)
...
**Current state:** LocationInput exists as React Native wrapper
...
1. READ matrices/ui/molecules/LocationInput.md for complete style properties
