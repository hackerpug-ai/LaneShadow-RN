================================================================================
TASK: UI-164 - BaseViewLayout (Ios)
================================================================================
...
Implement BaseViewLayout component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/BaseViewLayout.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: BaseViewLayoutTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/BaseViewLayout.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/BaseViewLayoutTests.swift (NEW)
