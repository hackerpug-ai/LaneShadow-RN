================================================================================
TASK: UI-089 - RationaleReveal (Android)
================================================================================
...
Implement RationaleReveal component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RationaleReveal.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RationaleRevealTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: RationaleReveal is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RationaleRevealTest.kt
  TEST_FUNCTION: testRationaleRevealDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RationaleRevealTest.kt
  TEST_FUNCTION: testRationaleRevealStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RationaleRevealTest.kt
  TEST_FUNCTION: testRationaleRevealStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/RationaleReveal.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/rationalereveal.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/RationaleReveal.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RationaleRevealTest.kt (NEW)
...
**Current state:** RationaleReveal exists as React Native wrapper
...
1. READ matrices/ui/molecules/RationaleReveal.md for complete style properties
