================================================================================
TASK: UI-172 - DownloadProgressScreen (Ios)
================================================================================
...
Implement DownloadProgressScreen component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/DownloadProgressScreen.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: DownloadProgressScreenTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/DownloadProgressScreen.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/DownloadProgressScreenTests.swift (NEW)
