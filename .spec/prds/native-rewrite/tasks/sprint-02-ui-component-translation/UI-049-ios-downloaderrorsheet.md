================================================================================
TASK: UI-049 - DownloadErrorSheet (Ios)
================================================================================
...
Implement DownloadErrorSheet component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/DownloadErrorSheet.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: DownloadErrorSheetTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/DownloadErrorSheet.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/DownloadErrorSheetTests.swift (NEW)
