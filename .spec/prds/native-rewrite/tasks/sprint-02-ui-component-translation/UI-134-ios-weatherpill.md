...
Implement WeatherPill component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/WeatherPill.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: WeatherPillTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/WeatherPill.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/WeatherPillTests.swift (NEW)
