================================================================================
TASK: UI-073 - MinimalOverlayWidget (Android)
================================================================================
...
Implement MinimalOverlayWidget component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/MinimalOverlayWidget.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/MinimalOverlayWidgetTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: MinimalOverlayWidget is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MinimalOverlayWidgetTest.kt
  TEST_FUNCTION: testMinimalOverlayWidgetDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MinimalOverlayWidgetTest.kt
  TEST_FUNCTION: testMinimalOverlayWidgetStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MinimalOverlayWidgetTest.kt
  TEST_FUNCTION: testMinimalOverlayWidgetStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/MinimalOverlayWidget.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/minimaloverlaywidget.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/MinimalOverlayWidget.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/MinimalOverlayWidgetTest.kt (NEW)
...
**Current state:** MinimalOverlayWidget exists as React Native wrapper
...
1. READ matrices/ui/molecules/MinimalOverlayWidget.md for complete style properties
