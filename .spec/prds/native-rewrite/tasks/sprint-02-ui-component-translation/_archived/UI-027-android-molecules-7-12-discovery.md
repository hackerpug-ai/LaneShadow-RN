# UI-027: Android molecules 7/12 — discovery: `DiscoveryFilterBar`, `DiscoverySortToggle`, `DiscoveryEmptyOverlay`, `DiscoveryLoadingOverlay`, `IntentSummaryPill`, `StateListItem`
...
Sprint 2 translates the React Native baseline into native platform components and sandbox scenarios before rider-facing feature sprints resume. This task covers the `molecules` slice for `Android molecules 7/12 — discovery: DiscoveryFilterBar, DiscoverySortToggle, DiscoveryEmptyOverlay, DiscoveryLoadingOverlay, IntentSummaryPill, StateListItem`.

**Objective:** Implement Android molecules 7/12 — discovery: `DiscoveryFilterBar`, `DiscoverySortToggle`, `DiscoveryEmptyOverlay`, `DiscoveryLoadingOverlay`, `IntentSummaryPill`, `StateListItem` as Jetpack Compose work with parity to the RN baseline, token-only styling, and sandbox coverage.
...
**THEN** The listed components or compositions exist in the correct Android Compose directories with parity-aligned names and signatures: `DiscoveryFilterBar`, `DiscoverySortToggle`, `DiscoveryEmptyOverlay`, `DiscoveryLoadingOverlay`, `IntentSummaryPill`, `StateListItem`.
...
|---|---|---|---|
| TC-1 | AC-1 | The listed components or compositions exist in the correct Android Compose directories with parity-aligned names and signatures: `DiscoveryFilterBar`, `DiscoverySortToggle`, `DiscoveryEmptyOverlay`, `DiscoveryLoadingOverlay`, `IntentSummaryPill`, `StateListItem`. | `printf "%s\n" "`DiscoveryFilterBar`, `DiscoverySortToggle`, `DiscoveryEmptyOverlay`, `DiscoveryLoadingOverlay`, `IntentSummaryPill`, `StateListItem`"` |
...
|---|---|---|---|---|
| DiscoveryFilterBar | **PLANNED** — not yet implemented in RN baseline | N/A (to be designed) | `android/app/src/main/java/com/laneshadow/ui/molecules/DiscoveryFilterBar.kt` | Horizontal scrollable filter chips × selected/unselected states |
| DiscoverySortToggle | **PLANNED** — not yet implemented in RN baseline | N/A (to be designed) | `android/app/src/main/java/com/laneshadow/ui/molecules/DiscoverySortToggle.kt` | Segmented control: Distance/Quality/Scenic × selected state |
| DiscoveryEmptyOverlay | **PLANNED** — not yet implemented in RN baseline | N/A (to be designed) | `android/app/src/main/java/com/laneshadow/ui/molecules/DiscoveryEmptyOverlay.kt` | Single variant with icon + headline + body text |
| DiscoveryLoadingOverlay | **PLANNED** — not yet implemented in RN baseline | N/A (to be designed) | `android/app/src/main/java/com/laneshadow/ui/molecules/DiscoveryLoadingOverlay.kt` | Single variant with progress indicator + loading text |
| IntentSummaryPill | **PLANNED** — not yet implemented in RN baseline | N/A (to be designed) | `android/app/src/main/java/com/laneshadow/ui/molecules/IntentSummaryPill.kt` | Compact pill showing current intent × dismissible state |
| StateListItem | **PLANNED** — not yet implemented in RN baseline | N/A (to be designed) | `android/app/src/main/java/com/laneshadow/ui/molecules/StateListItem.kt` | List item for state selection × selected/unselected/disabled states |
