================================================================================
TASK: MDL-010 - WeatherOptimization Model Translation
================================================================================
...
Translate weather-optimization model/logic from TypeScript to Kotlin following the MODEL translation plan.
...
AC-1: Public API matches source
  ...
  TEST_FILE: WeatherOptimizationTest.kt
...
1. matrices/models/MODEL-weather-optimization.md
   - Lines: ALL
   - Focus: SOURCE ANALYSIS and TRANSLATION STRATEGY

2. react-native/lib/weather-optimization.ts
   - Lines: ALL
...
- react-native/lib/weather-optimization.ts (MODIFY) — source is reference only

MUST:
- [ ] Follow translation strategy from MODEL-weather-optimization.md
...
class WeatherOptimizationManager(
...
**Current state:** weather-optimization exists as TypeScript module
...
1. READ matrices/models/MODEL-weather-optimization.md for complete translation strategy
...
Depends On:
- FND-006 — MODEL-weather-optimization.md translation plan complete
