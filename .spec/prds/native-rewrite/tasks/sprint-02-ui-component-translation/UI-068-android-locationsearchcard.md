================================================================================
TASK: UI-068 - LocationSearchCard (Android)
================================================================================
...
Implement LocationSearchCard component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/LocationSearchCard.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/LocationSearchCardTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: LocationSearchCard is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: LocationSearchCardTest.kt
  TEST_FUNCTION: testLocationSearchCardDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: LocationSearchCardTest.kt
  TEST_FUNCTION: testLocationSearchCardStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: LocationSearchCardTest.kt
  TEST_FUNCTION: testLocationSearchCardStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/LocationSearchCard.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/locationsearchcard.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/LocationSearchCard.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/LocationSearchCardTest.kt (NEW)
...
**Current state:** LocationSearchCard exists as React Native wrapper
...
1. READ matrices/ui/molecules/LocationSearchCard.md for complete style properties
