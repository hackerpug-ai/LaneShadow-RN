================================================================================
TASK: UI-043 - DeleteRouteDialog (Ios)
================================================================================
...
Implement DeleteRouteDialog component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/DeleteRouteDialog.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: DeleteRouteDialogTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/DeleteRouteDialog.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/DeleteRouteDialogTests.swift (NEW)
