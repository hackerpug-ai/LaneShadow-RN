================================================================================
TASK: UI-143 - DrawerMenu (Android)
================================================================================
...
Implement DrawerMenu component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/DrawerMenu.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/DrawerMenuTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: DrawerMenu is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: DrawerMenuTest.kt
  TEST_FUNCTION: testDrawerMenuDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: DrawerMenuTest.kt
  TEST_FUNCTION: testDrawerMenuStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: DrawerMenuTest.kt
  TEST_FUNCTION: testDrawerMenuStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/organisms/DrawerMenu.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/drawermenu.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/DrawerMenu.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/DrawerMenuTest.kt (NEW)
...
**Current state:** DrawerMenu exists as React Native wrapper
...
1. READ matrices/ui/organisms/DrawerMenu.md for complete style properties
