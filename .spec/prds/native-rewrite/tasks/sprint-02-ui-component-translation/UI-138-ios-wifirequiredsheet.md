================================================================================
TASK: UI-138 - WifiRequiredSheet (Ios)
================================================================================
...
Implement WifiRequiredSheet component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/WifiRequiredSheet.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: WifiRequiredSheetTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/WifiRequiredSheet.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/WifiRequiredSheetTests.swift (NEW)
