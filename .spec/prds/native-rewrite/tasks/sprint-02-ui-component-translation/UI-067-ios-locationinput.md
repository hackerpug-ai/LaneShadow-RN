...
Implement LocationInput component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/LocationInput.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: LocationInputTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/LocationInput.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/LocationInputTests.swift (NEW)
