...
Implement ErrorMessage component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/ErrorMessage.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: ErrorMessageTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/ErrorMessage.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/ErrorMessageTests.swift (NEW)
