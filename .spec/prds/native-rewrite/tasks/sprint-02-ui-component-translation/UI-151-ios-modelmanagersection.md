================================================================================
TASK: UI-151 - ModelManagerSection (Ios)
================================================================================
...
Implement ModelManagerSection component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/ModelManagerSection.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: ModelManagerSectionTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/ModelManagerSection.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/ModelManagerSectionTests.swift (NEW)
