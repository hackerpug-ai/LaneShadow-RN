================================================================================
TASK: UI-071 - MapPlanningIndicator (Ios)
================================================================================
...
Implement MapPlanningIndicator component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/MapPlanningIndicator.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: MapPlanningIndicatorTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/MapPlanningIndicator.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/MapPlanningIndicatorTests.swift (NEW)
...
// SwiftUI pattern
struct MapPlanningIndicator: View {
