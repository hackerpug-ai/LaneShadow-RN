================================================================================
TASK: UI-156 - RouteDirectionsSheet (Ios)
================================================================================
...
Implement RouteDirectionsSheet component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RouteDirectionsSheet.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: RouteDirectionsSheetTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/RouteDirectionsSheet.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/RouteDirectionsSheetTests.swift (NEW)
