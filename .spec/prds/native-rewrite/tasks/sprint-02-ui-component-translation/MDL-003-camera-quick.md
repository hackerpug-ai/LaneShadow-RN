================================================================================
TASK: MDL-003 - CameraQuick Model Translation
================================================================================
...
Translate camera-quick model/logic from TypeScript to Kotlin following the MODEL translation plan.
...
1. matrices/models/MODEL-camera-quick.md
   - Lines: ALL
   - Focus: SOURCE ANALYSIS and TRANSLATION STRATEGY

2. react-native/lib/camera-quick.ts
   - Lines: ALL
...
- react-native/lib/camera-quick.ts (MODIFY) — source is reference only

MUST:
- [ ] Follow translation strategy from MODEL-camera-quick.md
...
**Current state:** camera-quick exists as TypeScript module
...
1. READ matrices/models/MODEL-camera-quick.md for complete translation strategy
...
Depends On:
- FND-006 — MODEL-camera-quick.md translation plan complete
