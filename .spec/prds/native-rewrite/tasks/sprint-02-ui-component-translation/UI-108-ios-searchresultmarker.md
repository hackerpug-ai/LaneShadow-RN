================================================================================
TASK: UI-108 - SearchResultMarker (Ios)
================================================================================
...
Implement SearchResultMarker component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/SearchResultMarker.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: SearchResultMarkerTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/SearchResultMarker.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/SearchResultMarkerTests.swift (NEW)
