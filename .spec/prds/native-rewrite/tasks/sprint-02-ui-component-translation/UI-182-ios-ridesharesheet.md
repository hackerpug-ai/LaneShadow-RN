================================================================================
TASK: UI-182 - RideShareSheet (Ios)
================================================================================
...
Implement RideShareSheet component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RideShareSheet.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: RideShareSheetTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/RideShareSheet.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/RideShareSheetTests.swift (NEW)
