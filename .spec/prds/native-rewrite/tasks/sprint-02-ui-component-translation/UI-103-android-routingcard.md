================================================================================
TASK: UI-103 - RoutingCard (Android)
================================================================================
...
Implement RoutingCard component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RoutingCard.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RoutingCardTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: RoutingCard is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RoutingCardTest.kt
  TEST_FUNCTION: testRoutingCardDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RoutingCardTest.kt
  TEST_FUNCTION: testRoutingCardStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RoutingCardTest.kt
  TEST_FUNCTION: testRoutingCardStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/RoutingCard.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/routingcard.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/RoutingCard.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RoutingCardTest.kt (NEW)
...
**Current state:** RoutingCard exists as React Native wrapper
...
1. READ matrices/ui/molecules/RoutingCard.md for complete style properties
