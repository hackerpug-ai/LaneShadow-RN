================================================================================
TASK: UI-150 - MapViewWrapper (Ios)
================================================================================
...
Implement MapViewWrapper component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/MapViewWrapper.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: MapViewWrapperTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/MapViewWrapper.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/MapViewWrapperTests.swift (NEW)
