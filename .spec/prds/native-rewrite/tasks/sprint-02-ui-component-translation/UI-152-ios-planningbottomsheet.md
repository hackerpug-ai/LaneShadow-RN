================================================================================
TASK: UI-152 - PlanningBottomSheet (Ios)
================================================================================
...
Implement PlanningBottomSheet component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/PlanningBottomSheet.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: PlanningBottomSheetTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/PlanningBottomSheet.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/PlanningBottomSheetTests.swift (NEW)
...
// SwiftUI pattern
struct PlanningBottomSheet: View {
