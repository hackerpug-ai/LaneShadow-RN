================================================================================
TASK: UI-126 - TopographicBackground (Android)
================================================================================
...
Implement TopographicBackground component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/TopographicBackground.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/TopographicBackgroundTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: TopographicBackground is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: TopographicBackgroundTest.kt
  TEST_FUNCTION: testTopographicBackgroundDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: TopographicBackgroundTest.kt
  TEST_FUNCTION: testTopographicBackgroundStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: TopographicBackgroundTest.kt
  TEST_FUNCTION: testTopographicBackgroundStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/TopographicBackground.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/topographicbackground.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/TopographicBackground.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/TopographicBackgroundTest.kt (NEW)
...
**Current state:** TopographicBackground exists as React Native wrapper
...
1. READ matrices/ui/molecules/TopographicBackground.md for complete style properties
