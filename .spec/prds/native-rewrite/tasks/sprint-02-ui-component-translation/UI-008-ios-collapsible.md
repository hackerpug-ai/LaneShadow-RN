...
Implement Collapsible component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/Collapsible.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: CollapsibleTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/Collapsible.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/CollapsibleTests.swift (NEW)
