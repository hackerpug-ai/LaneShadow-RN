================================================================================
TASK: UI-011 - DragHandle (Android)
================================================================================
...
Implement DragHandle component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/DragHandle.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/DragHandleTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: DragHandle is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: DragHandleTest.kt
  TEST_FUNCTION: testDragHandleDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: DragHandleTest.kt
  TEST_FUNCTION: testDragHandleStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: DragHandleTest.kt
  TEST_FUNCTION: testDragHandleStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/atoms/DragHandle.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/draghandle.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/DragHandle.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/DragHandleTest.kt (NEW)
...
**Current state:** DragHandle exists as React Native wrapper
...
1. READ matrices/ui/atoms/DragHandle.md for complete style properties
