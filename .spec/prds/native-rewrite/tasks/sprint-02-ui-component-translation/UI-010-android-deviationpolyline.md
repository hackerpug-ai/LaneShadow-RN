================================================================================
TASK: UI-010 - DeviationPolyline (Android)
================================================================================
...
Implement DeviationPolyline component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/DeviationPolyline.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/DeviationPolylineTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: DeviationPolyline is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: DeviationPolylineTest.kt
  TEST_FUNCTION: testDeviationPolylineDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: DeviationPolylineTest.kt
  TEST_FUNCTION: testDeviationPolylineStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: DeviationPolylineTest.kt
  TEST_FUNCTION: testDeviationPolylineStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/atoms/DeviationPolyline.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/deviationpolyline.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/DeviationPolyline.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/DeviationPolylineTest.kt (NEW)
...
**Current state:** DeviationPolyline exists as React Native wrapper
...
1. READ matrices/ui/atoms/DeviationPolyline.md for complete style properties
