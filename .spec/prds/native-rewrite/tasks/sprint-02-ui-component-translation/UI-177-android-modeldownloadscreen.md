================================================================================
TASK: UI-177 - ModelDownloadScreen (Android)
================================================================================
...
Implement ModelDownloadScreen component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/ModelDownloadScreen.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/ModelDownloadScreenTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: ModelDownloadScreen is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ModelDownloadScreenTest.kt
  TEST_FUNCTION: testModelDownloadScreenDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ModelDownloadScreenTest.kt
  TEST_FUNCTION: testModelDownloadScreenStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ModelDownloadScreenTest.kt
  TEST_FUNCTION: testModelDownloadScreenStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/screens/ModelDownloadScreen.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/modeldownloadscreen.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/ModelDownloadScreen.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/ModelDownloadScreenTest.kt (NEW)
...
**Current state:** ModelDownloadScreen exists as React Native wrapper
...
1. READ matrices/ui/screens/ModelDownloadScreen.md for complete style properties
