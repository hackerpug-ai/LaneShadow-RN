================================================================================
TASK: UI-078 - PermissionNotification (Android)
================================================================================
...
Implement PermissionNotification component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/PermissionNotification.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/PermissionNotificationTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: PermissionNotification is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: PermissionNotificationTest.kt
  TEST_FUNCTION: testPermissionNotificationDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: PermissionNotificationTest.kt
  TEST_FUNCTION: testPermissionNotificationStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: PermissionNotificationTest.kt
  TEST_FUNCTION: testPermissionNotificationStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/PermissionNotification.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/permissionnotification.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/PermissionNotification.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/PermissionNotificationTest.kt (NEW)
...
**Current state:** PermissionNotification exists as React Native wrapper
...
1. READ matrices/ui/molecules/PermissionNotification.md for complete style properties
