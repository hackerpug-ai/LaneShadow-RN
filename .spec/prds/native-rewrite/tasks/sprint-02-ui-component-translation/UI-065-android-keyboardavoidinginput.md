================================================================================
TASK: UI-065 - KeyboardAvoidingInput (Android)
================================================================================
...
Implement KeyboardAvoidingInput component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/KeyboardAvoidingInput.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/KeyboardAvoidingInputTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: KeyboardAvoidingInput is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: KeyboardAvoidingInputTest.kt
  TEST_FUNCTION: testKeyboardAvoidingInputDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: KeyboardAvoidingInputTest.kt
  TEST_FUNCTION: testKeyboardAvoidingInputStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: KeyboardAvoidingInputTest.kt
  TEST_FUNCTION: testKeyboardAvoidingInputStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/KeyboardAvoidingInput.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/keyboardavoidinginput.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/KeyboardAvoidingInput.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/KeyboardAvoidingInputTest.kt (NEW)
...
**Current state:** KeyboardAvoidingInput exists as React Native wrapper
...
1. READ matrices/ui/molecules/KeyboardAvoidingInput.md for complete style properties
