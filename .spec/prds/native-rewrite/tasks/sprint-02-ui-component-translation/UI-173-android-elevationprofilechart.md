================================================================================
TASK: UI-173 - ElevationProfileChart (Android)
================================================================================
...
Implement ElevationProfileChart component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/ElevationProfileChart.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/ElevationProfileChartTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: ElevationProfileChart is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ElevationProfileChartTest.kt
  TEST_FUNCTION: testElevationProfileChartDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ElevationProfileChartTest.kt
  TEST_FUNCTION: testElevationProfileChartStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ElevationProfileChartTest.kt
  TEST_FUNCTION: testElevationProfileChartStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/templates/ElevationProfileChart.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/elevationprofilechart.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/ElevationProfileChart.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/ElevationProfileChartTest.kt (NEW)
...
**Current state:** ElevationProfileChart exists as React Native wrapper
...
1. READ matrices/ui/templates/ElevationProfileChart.md for complete style properties
