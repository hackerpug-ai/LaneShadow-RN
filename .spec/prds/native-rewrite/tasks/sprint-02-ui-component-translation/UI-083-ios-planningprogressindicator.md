================================================================================
TASK: UI-083 - PlanningProgressIndicator (Ios)
================================================================================
...
Implement PlanningProgressIndicator component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/PlanningProgressIndicator.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: PlanningProgressIndicatorTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/PlanningProgressIndicator.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/PlanningProgressIndicatorTests.swift (NEW)
...
// SwiftUI pattern
struct PlanningProgressIndicator: View {
