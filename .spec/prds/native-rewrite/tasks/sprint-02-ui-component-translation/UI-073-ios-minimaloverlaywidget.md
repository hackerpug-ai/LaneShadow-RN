================================================================================
TASK: UI-073 - MinimalOverlayWidget (Ios)
================================================================================
...
Implement MinimalOverlayWidget component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/MinimalOverlayWidget.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: MinimalOverlayWidgetTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/MinimalOverlayWidget.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/MinimalOverlayWidgetTests.swift (NEW)
...
// SwiftUI pattern
struct MinimalOverlayWidget: View {
