================================================================================
TASK: MDL-007 - ModelDownload Model Translation
================================================================================
...
Translate model-download model/logic from TypeScript to Kotlin following the MODEL translation plan.
...
AC-1: Public API matches source
  ...
  TEST_FILE: ModelDownloadTest.kt
...
1. matrices/models/MODEL-model-download.md
   - Lines: ALL
   - Focus: SOURCE ANALYSIS and TRANSLATION STRATEGY

2. react-native/lib/model-download.ts
   - Lines: ALL
...
- react-native/lib/model-download.ts (MODIFY) — source is reference only

MUST:
- [ ] Follow translation strategy from MODEL-model-download.md
...
**Current state:** model-download exists as TypeScript module
...
1. READ matrices/models/MODEL-model-download.md for complete translation strategy
...
Depends On:
- FND-006 — MODEL-model-download.md translation plan complete
