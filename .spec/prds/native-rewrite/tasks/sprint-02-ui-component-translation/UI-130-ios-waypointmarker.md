================================================================================
TASK: UI-130 - WaypointMarker (Ios)
================================================================================
...
Implement WaypointMarker component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/WaypointMarker.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: WaypointMarkerTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/WaypointMarker.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/WaypointMarkerTests.swift (NEW)
