...
Implement Checkbox component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/Checkbox.kt (NEW): SwiftUI implementation
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/Checkbox.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/CheckboxTests.swift (NEW)
