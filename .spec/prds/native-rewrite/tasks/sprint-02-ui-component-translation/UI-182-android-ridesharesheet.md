================================================================================
TASK: UI-182 - RideShareSheet (Android)
================================================================================
...
Implement RideShareSheet component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RideShareSheet.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RideShareSheetTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: RideShareSheet is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RideShareSheetTest.kt
  TEST_FUNCTION: testRideShareSheetDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RideShareSheetTest.kt
  TEST_FUNCTION: testRideShareSheetStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RideShareSheetTest.kt
  TEST_FUNCTION: testRideShareSheetStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/templates/RideShareSheet.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/ridesharesheet.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/RideShareSheet.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RideShareSheetTest.kt (NEW)
...
**Current state:** RideShareSheet exists as React Native wrapper
...
1. READ matrices/ui/templates/RideShareSheet.md for complete style properties
