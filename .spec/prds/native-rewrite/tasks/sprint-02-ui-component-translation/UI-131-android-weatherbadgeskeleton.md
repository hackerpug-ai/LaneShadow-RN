================================================================================
TASK: UI-131 - WeatherBadgeSkeleton (Android)
================================================================================
...
Implement WeatherBadgeSkeleton component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/WeatherBadgeSkeleton.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/WeatherBadgeSkeletonTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: WeatherBadgeSkeleton is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WeatherBadgeSkeletonTest.kt
  TEST_FUNCTION: testWeatherBadgeSkeletonDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WeatherBadgeSkeletonTest.kt
  TEST_FUNCTION: testWeatherBadgeSkeletonStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WeatherBadgeSkeletonTest.kt
  TEST_FUNCTION: testWeatherBadgeSkeletonStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/WeatherBadgeSkeleton.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/weatherbadgeskeleton.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/WeatherBadgeSkeleton.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/WeatherBadgeSkeletonTest.kt (NEW)
...
**Current state:** WeatherBadgeSkeleton exists as React Native wrapper
...
1. READ matrices/ui/molecules/WeatherBadgeSkeleton.md for complete style properties
