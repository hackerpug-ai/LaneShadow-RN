...
Implement WhereToBar component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/WhereToBar.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: WhereToBarTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/WhereToBar.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/WhereToBarTests.swift (NEW)
