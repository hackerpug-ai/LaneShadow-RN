================================================================================
TASK: UI-109 - SectionHeader (Android)
================================================================================
...
Implement SectionHeader component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/SectionHeader.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/SectionHeaderTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: SectionHeader is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: SectionHeaderTest.kt
  TEST_FUNCTION: testSectionHeaderDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: SectionHeaderTest.kt
  TEST_FUNCTION: testSectionHeaderStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: SectionHeaderTest.kt
  TEST_FUNCTION: testSectionHeaderStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/SectionHeader.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/sectionheader.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/SectionHeader.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/SectionHeaderTest.kt (NEW)
...
**Current state:** SectionHeader exists as React Native wrapper
...
1. READ matrices/ui/molecules/SectionHeader.md for complete style properties
