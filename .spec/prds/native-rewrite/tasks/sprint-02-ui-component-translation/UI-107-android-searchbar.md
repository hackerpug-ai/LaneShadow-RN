...
Implement SearchBar component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/SearchBar.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/SearchBarTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: SearchBar is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: SearchBarTest.kt
  TEST_FUNCTION: testSearchBarDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: SearchBarTest.kt
  TEST_FUNCTION: testSearchBarStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: SearchBarTest.kt
  TEST_FUNCTION: testSearchBarStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/SearchBar.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/searchbar.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/SearchBar.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/SearchBarTest.kt (NEW)
...
**Current state:** SearchBar exists as React Native wrapper
...
1. READ matrices/ui/molecules/SearchBar.md for complete style properties
