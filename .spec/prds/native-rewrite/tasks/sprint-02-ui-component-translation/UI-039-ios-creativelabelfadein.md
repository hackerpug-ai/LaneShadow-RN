================================================================================
TASK: UI-039 - CreativeLabelFadeIn (Ios)
================================================================================
...
Implement CreativeLabelFadeIn component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/CreativeLabelFadeIn.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: CreativeLabelFadeInTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/CreativeLabelFadeIn.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/CreativeLabelFadeInTests.swift (NEW)
