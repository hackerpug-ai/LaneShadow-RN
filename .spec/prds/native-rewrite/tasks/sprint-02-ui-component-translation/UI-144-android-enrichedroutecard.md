================================================================================
TASK: UI-144 - EnrichedRouteCard (Android)
================================================================================
...
Implement EnrichedRouteCard component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/EnrichedRouteCard.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/EnrichedRouteCardTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: EnrichedRouteCard is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: EnrichedRouteCardTest.kt
  TEST_FUNCTION: testEnrichedRouteCardDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: EnrichedRouteCardTest.kt
  TEST_FUNCTION: testEnrichedRouteCardStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: EnrichedRouteCardTest.kt
  TEST_FUNCTION: testEnrichedRouteCardStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/organisms/EnrichedRouteCard.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/enrichedroutecard.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/EnrichedRouteCard.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/EnrichedRouteCardTest.kt (NEW)
...
**Current state:** EnrichedRouteCard exists as React Native wrapper
...
1. READ matrices/ui/organisms/EnrichedRouteCard.md for complete style properties
