================================================================================
TASK: UI-059 - FloatingSearchInput (Ios)
================================================================================
...
Implement FloatingSearchInput component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/FloatingSearchInput.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: FloatingSearchInputTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/FloatingSearchInput.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/FloatingSearchInputTests.swift (NEW)
...
// SwiftUI pattern
struct FloatingSearchInput: View {
