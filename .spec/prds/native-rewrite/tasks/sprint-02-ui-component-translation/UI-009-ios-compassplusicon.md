================================================================================
TASK: UI-009 - CompassPlusIcon (Ios)
================================================================================
...
Implement CompassPlusIcon component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/CompassPlusIcon.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: CompassPlusIconTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/CompassPlusIcon.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/CompassPlusIconTests.swift (NEW)
