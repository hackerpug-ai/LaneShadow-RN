================================================================================
TASK: UI-161 - VoiceAssistantOverlay (Ios)
================================================================================
...
Implement VoiceAssistantOverlay component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/VoiceAssistantOverlay.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: VoiceAssistantOverlayTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/VoiceAssistantOverlay.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/VoiceAssistantOverlayTests.swift (NEW)
