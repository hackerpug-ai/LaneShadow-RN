================================================================================
TASK: UI-075 - NewSessionButton (Ios)
================================================================================
...
Implement NewSessionButton component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/NewSessionButton.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: NewSessionButtonTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/NewSessionButton.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/NewSessionButtonTests.swift (NEW)
