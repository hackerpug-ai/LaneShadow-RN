================================================================================
TASK: UI-013 - IconSymbol-iOS (Android)
================================================================================
...
Implement IconSymbol-iOS component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/IconSymbol-iOS.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/IconSymbol-iOSTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: IconSymbol-iOS is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: IconSymbol-iOSTest.kt
  TEST_FUNCTION: testIconSymbol-iOSDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: IconSymbol-iOSTest.kt
  TEST_FUNCTION: testIconSymbol-iOSStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: IconSymbol-iOSTest.kt
  TEST_FUNCTION: testIconSymbol-iOSStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/atoms/IconSymbol-iOS.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/iconsymbol-ios.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/IconSymbol-iOS.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/IconSymbol-iOSTest.kt (NEW)
...
**Current state:** IconSymbol-iOS exists as React Native wrapper
...
1. READ matrices/ui/atoms/IconSymbol-iOS.md for complete style properties
