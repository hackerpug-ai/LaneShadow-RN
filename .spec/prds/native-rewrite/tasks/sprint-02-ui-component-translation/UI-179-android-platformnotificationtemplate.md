================================================================================
TASK: UI-179 - PlatformNotificationTemplate (Android)
================================================================================
...
Implement PlatformNotificationTemplate component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/PlatformNotificationTemplate.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/PlatformNotificationTemplateTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: PlatformNotificationTemplate is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: PlatformNotificationTemplateTest.kt
  TEST_FUNCTION: testPlatformNotificationTemplateDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: PlatformNotificationTemplateTest.kt
  TEST_FUNCTION: testPlatformNotificationTemplateStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: PlatformNotificationTemplateTest.kt
  TEST_FUNCTION: testPlatformNotificationTemplateStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/templates/PlatformNotificationTemplate.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/platformnotificationtemplate.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/PlatformNotificationTemplate.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/PlatformNotificationTemplateTest.kt (NEW)
...
@Composable
fun PlatformNotificationTemplate(
...
**Current state:** PlatformNotificationTemplate exists as React Native wrapper
...
1. READ matrices/ui/templates/PlatformNotificationTemplate.md for complete style properties
