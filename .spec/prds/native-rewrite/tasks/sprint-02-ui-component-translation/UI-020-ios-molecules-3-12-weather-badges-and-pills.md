# UI-020: iOS molecules 3/12 — weather badges & pills: `ThemeWeatherPill`, `ThemeTemperatureBadge`, `ThemeRainBadge`, `ThemeWindBadge`, `WeatherOverlay`, `ThemeWeatherGauge`, `ThemeWeatherPillsRow`
...
Sprint 2 translates the React Native baseline into native platform components and sandbox scenarios before rider-facing feature sprints resume. This task covers the `molecules` slice for `iOS molecules 3/12 — weather badges & pills: ThemeWeatherPill, ThemeTemperatureBadge, ThemeRainBadge, ThemeWindBadge, WeatherOverlay, ThemeWeatherGauge, ThemeWeatherPillsRow`.

**Objective:** Implement iOS molecules 3/12 — weather badges & pills: `ThemeWeatherPill`, `ThemeTemperatureBadge`, `ThemeRainBadge`, `ThemeWindBadge`, `WeatherOverlay`, `ThemeWeatherGauge`, `ThemeWeatherPillsRow` as SwiftUI work with parity to the RN baseline, token-only styling, and sandbox coverage.
...
### MUST
- Implement the listed components or compositions with parity-aligned naming and interfaces: `ThemeWeatherPill`, `ThemeTemperatureBadge`, `ThemeRainBadge`, `ThemeWindBadge`, `WeatherOverlay`, `ThemeWeatherGauge`, `ThemeWeatherPillsRow`.
...
**THEN** The listed components or compositions exist in the correct iOS SwiftUI directories with parity-aligned names and signatures: `ThemeWeatherPill`, `ThemeTemperatureBadge`, `ThemeRainBadge`, `ThemeWindBadge`, `WeatherOverlay`, `ThemeWeatherGauge`, `ThemeWeatherPillsRow`.
**Verify:** `printf "%s\n" "`ThemeWeatherPill`, `ThemeTemperatureBadge`, `ThemeRainBadge`, `ThemeWindBadge`, `WeatherOverlay`, `ThemeWeatherGauge`, `ThemeWeatherPillsRow`"`
...
|---|---|---|---|
| TC-1 | AC-1 | The listed components or compositions exist in the correct iOS SwiftUI directories with parity-aligned names and signatures: `ThemeWeatherPill`, `ThemeTemperatureBadge`, `ThemeRainBadge`, `ThemeWindBadge`, `WeatherOverlay`, `ThemeWeatherGauge`, `ThemeWeatherPillsRow`. | `printf "%s\n" "`ThemeWeatherPill`, `ThemeTemperatureBadge`, `ThemeRainBadge`, `ThemeWindBadge`, `WeatherOverlay`, `ThemeWeatherGauge`, `ThemeWeatherPillsRow`"` |
