================================================================================
TASK: UI-185 - RouteOptionsScreen (Ios)
================================================================================
...
Implement RouteOptionsScreen component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RouteOptionsScreen.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: RouteOptionsScreenTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/RouteOptionsScreen.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/RouteOptionsScreenTests.swift (NEW)
...
// SwiftUI pattern
struct RouteOptionsScreen: View {
