================================================================================
TASK: UI-009 - CompassPlusIcon (Android)
================================================================================
...
Implement CompassPlusIcon component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/CompassPlusIcon.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/CompassPlusIconTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: CompassPlusIcon is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: CompassPlusIconTest.kt
  TEST_FUNCTION: testCompassPlusIconDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: CompassPlusIconTest.kt
  TEST_FUNCTION: testCompassPlusIconStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: CompassPlusIconTest.kt
  TEST_FUNCTION: testCompassPlusIconStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/atoms/CompassPlusIcon.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/compassplusicon.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/CompassPlusIcon.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/CompassPlusIconTest.kt (NEW)
...
**Current state:** CompassPlusIcon exists as React Native wrapper
...
1. READ matrices/ui/atoms/CompassPlusIcon.md for complete style properties
