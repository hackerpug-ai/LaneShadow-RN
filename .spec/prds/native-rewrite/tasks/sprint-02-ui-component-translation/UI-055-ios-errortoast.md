...
Implement ErrorToast component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/ErrorToast.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: ErrorToastTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/ErrorToast.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/ErrorToastTests.swift (NEW)
