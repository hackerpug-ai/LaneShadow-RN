...
Implement RoutePolyline component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RoutePolyline.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: RoutePolylineTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/RoutePolyline.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/RoutePolylineTests.swift (NEW)
