================================================================================
TASK: UI-149 - MapToastStack (Android)
================================================================================
...
Implement MapToastStack component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/MapToastStack.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/MapToastStackTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: MapToastStack is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MapToastStackTest.kt
  TEST_FUNCTION: testMapToastStackDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MapToastStackTest.kt
  TEST_FUNCTION: testMapToastStackStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MapToastStackTest.kt
  TEST_FUNCTION: testMapToastStackStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/organisms/MapToastStack.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/maptoaststack.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/MapToastStack.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/MapToastStackTest.kt (NEW)
...
**Current state:** MapToastStack exists as React Native wrapper
...
1. READ matrices/ui/organisms/MapToastStack.md for complete style properties
