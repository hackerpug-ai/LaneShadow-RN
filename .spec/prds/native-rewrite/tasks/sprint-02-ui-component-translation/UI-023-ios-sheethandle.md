...
Implement SheetHandle component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/SheetHandle.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: SheetHandleTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/SheetHandle.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/SheetHandleTests.swift (NEW)
