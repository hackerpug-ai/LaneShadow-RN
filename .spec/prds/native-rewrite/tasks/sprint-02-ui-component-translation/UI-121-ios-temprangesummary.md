================================================================================
TASK: UI-121 - TempRangeSummary (Ios)
================================================================================
...
Implement TempRangeSummary component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/TempRangeSummary.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: TempRangeSummaryTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/TempRangeSummary.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/TempRangeSummaryTests.swift (NEW)
