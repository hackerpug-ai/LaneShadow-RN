================================================================================
TASK: UI-043 - DeleteRouteDialog (Android)
================================================================================
...
Implement DeleteRouteDialog component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/DeleteRouteDialog.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/DeleteRouteDialogTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  TEST_FILE: DeleteRouteDialogTest.kt
  TEST_FUNCTION: testDeleteRouteDialogDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: DeleteRouteDialogTest.kt
  TEST_FUNCTION: testDeleteRouteDialogStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: DeleteRouteDialogTest.kt
  TEST_FUNCTION: testDeleteRouteDialogStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/DeleteRouteDialog.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/deleteroutedialog.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/DeleteRouteDialog.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/DeleteRouteDialogTest.kt (NEW)
...
**Current state:** DeleteRouteDialog exists as React Native wrapper
...
1. READ matrices/ui/molecules/DeleteRouteDialog.md for complete style properties
