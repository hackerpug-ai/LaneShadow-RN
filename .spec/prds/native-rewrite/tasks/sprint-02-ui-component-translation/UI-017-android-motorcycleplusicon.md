================================================================================
TASK: UI-017 - MotorcyclePlusIcon (Android)
================================================================================
...
Implement MotorcyclePlusIcon component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/MotorcyclePlusIcon.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/MotorcyclePlusIconTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: MotorcyclePlusIcon is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MotorcyclePlusIconTest.kt
  TEST_FUNCTION: testMotorcyclePlusIconDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MotorcyclePlusIconTest.kt
  TEST_FUNCTION: testMotorcyclePlusIconStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MotorcyclePlusIconTest.kt
  TEST_FUNCTION: testMotorcyclePlusIconStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/atoms/MotorcyclePlusIcon.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/motorcycleplusicon.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/MotorcyclePlusIcon.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/MotorcyclePlusIconTest.kt (NEW)
...
**Current state:** MotorcyclePlusIcon exists as React Native wrapper
...
1. READ matrices/ui/atoms/MotorcyclePlusIcon.md for complete style properties
