...
Implement AuthCard component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/AuthCard.kt (NEW): SwiftUI implementation
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/AuthCard.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/AuthCardTests.swift (NEW)
