...
Implement StateListItem component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/StateListItem.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: StateListItemTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/StateListItem.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/StateListItemTests.swift (NEW)
