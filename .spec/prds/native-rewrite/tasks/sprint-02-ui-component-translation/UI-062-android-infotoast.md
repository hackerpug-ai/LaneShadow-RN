...
Implement InfoToast component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/InfoToast.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/InfoToastTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: InfoToast is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: InfoToastTest.kt
  TEST_FUNCTION: testInfoToastDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: InfoToastTest.kt
  TEST_FUNCTION: testInfoToastStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: InfoToastTest.kt
  TEST_FUNCTION: testInfoToastStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/InfoToast.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/infotoast.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/InfoToast.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/InfoToastTest.kt (NEW)
...
**Current state:** InfoToast exists as React Native wrapper
...
1. READ matrices/ui/molecules/InfoToast.md for complete style properties
