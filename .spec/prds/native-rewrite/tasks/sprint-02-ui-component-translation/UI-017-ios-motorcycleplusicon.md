================================================================================
TASK: UI-017 - MotorcyclePlusIcon (Ios)
================================================================================
...
Implement MotorcyclePlusIcon component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/MotorcyclePlusIcon.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: MotorcyclePlusIconTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/MotorcyclePlusIcon.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/MotorcyclePlusIconTests.swift (NEW)
...
// SwiftUI pattern
struct MotorcyclePlusIcon: View {
