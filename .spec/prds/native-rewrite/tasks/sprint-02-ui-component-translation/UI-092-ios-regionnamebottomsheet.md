================================================================================
TASK: UI-092 - RegionNameBottomSheet (Ios)
================================================================================
...
Implement RegionNameBottomSheet component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RegionNameBottomSheet.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: RegionNameBottomSheetTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/RegionNameBottomSheet.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/RegionNameBottomSheetTests.swift (NEW)
