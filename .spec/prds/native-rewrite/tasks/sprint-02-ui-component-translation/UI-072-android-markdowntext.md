================================================================================
TASK: UI-072 - MarkdownText (Android)
================================================================================
...
Implement MarkdownText component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/MarkdownText.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/MarkdownTextTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: MarkdownText is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MarkdownTextTest.kt
  TEST_FUNCTION: testMarkdownTextDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MarkdownTextTest.kt
  TEST_FUNCTION: testMarkdownTextStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MarkdownTextTest.kt
  TEST_FUNCTION: testMarkdownTextStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/MarkdownText.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/markdowntext.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/MarkdownText.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/MarkdownTextTest.kt (NEW)
...
**Current state:** MarkdownText exists as React Native wrapper
...
1. READ matrices/ui/molecules/MarkdownText.md for complete style properties
