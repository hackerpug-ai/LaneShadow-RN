...
Implement Speedometer component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/Speedometer.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: SpeedometerTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/Speedometer.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/SpeedometerTests.swift (NEW)
