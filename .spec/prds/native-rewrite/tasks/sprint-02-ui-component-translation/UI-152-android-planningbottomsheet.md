================================================================================
TASK: UI-152 - PlanningBottomSheet (Android)
================================================================================
...
Implement PlanningBottomSheet component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/PlanningBottomSheet.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/PlanningBottomSheetTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: PlanningBottomSheet is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: PlanningBottomSheetTest.kt
  TEST_FUNCTION: testPlanningBottomSheetDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: PlanningBottomSheetTest.kt
  TEST_FUNCTION: testPlanningBottomSheetStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: PlanningBottomSheetTest.kt
  TEST_FUNCTION: testPlanningBottomSheetStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/organisms/PlanningBottomSheet.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/planningbottomsheet.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/PlanningBottomSheet.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/PlanningBottomSheetTest.kt (NEW)
...
**Current state:** PlanningBottomSheet exists as React Native wrapper
...
1. READ matrices/ui/organisms/PlanningBottomSheet.md for complete style properties
