================================================================================
TASK: UI-059 - FloatingSearchInput (Android)
================================================================================
...
Implement FloatingSearchInput component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/FloatingSearchInput.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/FloatingSearchInputTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: FloatingSearchInput is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: FloatingSearchInputTest.kt
  TEST_FUNCTION: testFloatingSearchInputDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: FloatingSearchInputTest.kt
  TEST_FUNCTION: testFloatingSearchInputStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: FloatingSearchInputTest.kt
  TEST_FUNCTION: testFloatingSearchInputStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/FloatingSearchInput.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/floatingsearchinput.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/FloatingSearchInput.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/FloatingSearchInputTest.kt (NEW)
...
**Current state:** FloatingSearchInput exists as React Native wrapper
...
1. READ matrices/ui/molecules/FloatingSearchInput.md for complete style properties
