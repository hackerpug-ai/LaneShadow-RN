================================================================================
TASK: MDL-001 - AtomicWrite Model Translation
================================================================================
...
Translate atomic-write model/logic from TypeScript to Kotlin following the MODEL translation plan.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/models/AtomicWrite.kt (NEW): Kotlin implementation
- react-native/android/app/src/test/java/com/laneshadow/models/AtomicWriteTest.kt (NEW): Model tests
...
1. matrices/models/MODEL-atomic-write.md
   - Lines: ALL
   - Focus: SOURCE ANALYSIS and TRANSLATION STRATEGY

2. react-native/lib/atomic-write.ts
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/models/AtomicWrite.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/models/AtomicWriteTest.kt (NEW)

WRITE-PROHIBITED:
- matrices/** — read-only references
- react-native/lib/atomic-write.ts (MODIFY) — source is reference only

MUST:
- [ ] Follow translation strategy from MODEL-atomic-write.md
...
**Current state:** atomic-write exists as TypeScript module
...
1. READ matrices/models/MODEL-atomic-write.md for complete translation strategy
...
Depends On:
- FND-006 — MODEL-atomic-write.md translation plan complete
