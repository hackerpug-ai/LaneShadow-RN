================================================================================
TASK: UI-042 - DeleteFavoriteDialog (Ios)
================================================================================
...
Implement DeleteFavoriteDialog component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/DeleteFavoriteDialog.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: DeleteFavoriteDialogTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/DeleteFavoriteDialog.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/DeleteFavoriteDialogTests.swift (NEW)
...
// SwiftUI pattern
struct DeleteFavoriteDialog: View {
