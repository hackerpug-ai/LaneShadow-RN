================================================================================
TASK: UI-112 - SessionContextMenu (Android)
================================================================================
...
Implement SessionContextMenu component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/SessionContextMenu.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/SessionContextMenuTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: SessionContextMenu is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: SessionContextMenuTest.kt
  TEST_FUNCTION: testSessionContextMenuDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: SessionContextMenuTest.kt
  TEST_FUNCTION: testSessionContextMenuStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: SessionContextMenuTest.kt
  TEST_FUNCTION: testSessionContextMenuStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/SessionContextMenu.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/sessioncontextmenu.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/SessionContextMenu.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/SessionContextMenuTest.kt (NEW)
...
**Current state:** SessionContextMenu exists as React Native wrapper
...
1. READ matrices/ui/molecules/SessionContextMenu.md for complete style properties
