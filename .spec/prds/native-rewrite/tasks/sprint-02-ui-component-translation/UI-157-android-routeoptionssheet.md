================================================================================
TASK: UI-157 - RouteOptionsSheet (Android)
================================================================================
...
Implement RouteOptionsSheet component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RouteOptionsSheet.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RouteOptionsSheetTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: RouteOptionsSheet is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RouteOptionsSheetTest.kt
  TEST_FUNCTION: testRouteOptionsSheetDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RouteOptionsSheetTest.kt
  TEST_FUNCTION: testRouteOptionsSheetStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RouteOptionsSheetTest.kt
  TEST_FUNCTION: testRouteOptionsSheetStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/organisms/RouteOptionsSheet.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/routeoptionssheet.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/RouteOptionsSheet.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RouteOptionsSheetTest.kt (NEW)
...
**Current state:** RouteOptionsSheet exists as React Native wrapper
...
1. READ matrices/ui/organisms/RouteOptionsSheet.md for complete style properties
