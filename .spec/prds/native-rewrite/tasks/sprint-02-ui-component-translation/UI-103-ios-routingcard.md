...
Implement RoutingCard component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RoutingCard.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: RoutingCardTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/RoutingCard.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/RoutingCardTests.swift (NEW)
