================================================================================
TASK: UI-075 - NewSessionButton (Android)
================================================================================
...
Implement NewSessionButton component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/NewSessionButton.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/NewSessionButtonTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: NewSessionButton is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: NewSessionButtonTest.kt
  TEST_FUNCTION: testNewSessionButtonDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: NewSessionButtonTest.kt
  TEST_FUNCTION: testNewSessionButtonStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: NewSessionButtonTest.kt
  TEST_FUNCTION: testNewSessionButtonStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/NewSessionButton.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/newsessionbutton.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/NewSessionButton.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/NewSessionButtonTest.kt (NEW)
...
**Current state:** NewSessionButton exists as React Native wrapper
...
1. READ matrices/ui/molecules/NewSessionButton.md for complete style properties
