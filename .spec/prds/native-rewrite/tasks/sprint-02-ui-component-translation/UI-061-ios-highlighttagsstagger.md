================================================================================
TASK: UI-061 - HighlightTagsStagger (Ios)
================================================================================
...
Implement HighlightTagsStagger component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/HighlightTagsStagger.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: HighlightTagsStaggerTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/HighlightTagsStagger.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/HighlightTagsStaggerTests.swift (NEW)
