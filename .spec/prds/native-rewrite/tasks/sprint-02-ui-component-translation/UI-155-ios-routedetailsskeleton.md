================================================================================
TASK: UI-155 - RouteDetailsSkeleton (Ios)
================================================================================
...
Implement RouteDetailsSkeleton component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RouteDetailsSkeleton.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: RouteDetailsSkeletonTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/RouteDetailsSkeleton.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/RouteDetailsSkeletonTests.swift (NEW)
