...
Implement MarkdownText component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/MarkdownText.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: MarkdownTextTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/MarkdownText.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/MarkdownTextTests.swift (NEW)
