================================================================================
TASK: UI-050 - DownloadProgressBanner (Ios)
================================================================================
...
Implement DownloadProgressBanner component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/DownloadProgressBanner.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: DownloadProgressBannerTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/DownloadProgressBanner.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/DownloadProgressBannerTests.swift (NEW)
