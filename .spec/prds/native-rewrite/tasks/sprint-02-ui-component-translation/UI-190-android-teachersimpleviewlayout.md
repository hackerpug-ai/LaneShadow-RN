================================================================================
TASK: UI-190 - TeacherSimpleViewLayout (Android)
================================================================================
...
Implement TeacherSimpleViewLayout component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/TeacherSimpleViewLayout.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/TeacherSimpleViewLayoutTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: TeacherSimpleViewLayout is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: TeacherSimpleViewLayoutTest.kt
  TEST_FUNCTION: testTeacherSimpleViewLayoutDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: TeacherSimpleViewLayoutTest.kt
  TEST_FUNCTION: testTeacherSimpleViewLayoutStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: TeacherSimpleViewLayoutTest.kt
  TEST_FUNCTION: testTeacherSimpleViewLayoutStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/screens/TeacherSimpleViewLayout.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/teachersimpleviewlayout.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/TeacherSimpleViewLayout.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/TeacherSimpleViewLayoutTest.kt (NEW)
...
**Current state:** TeacherSimpleViewLayout exists as React Native wrapper
...
1. READ matrices/ui/screens/TeacherSimpleViewLayout.md for complete style properties
