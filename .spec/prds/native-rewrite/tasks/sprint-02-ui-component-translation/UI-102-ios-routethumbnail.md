================================================================================
TASK: UI-102 - RouteThumbnail (Ios)
================================================================================
...
Implement RouteThumbnail component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RouteThumbnail.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: RouteThumbnailTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/RouteThumbnail.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/RouteThumbnailTests.swift (NEW)
