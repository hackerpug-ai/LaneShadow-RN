================================================================================
TASK: UI-074 - MinimalOverlayWidgetPreview (Android)
================================================================================
...
Implement MinimalOverlayWidgetPreview component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/MinimalOverlayWidgetPreview.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/MinimalOverlayWidgetPreviewTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: MinimalOverlayWidgetPreview is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MinimalOverlayWidgetPreviewTest.kt
  TEST_FUNCTION: testMinimalOverlayWidgetPreviewDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MinimalOverlayWidgetPreviewTest.kt
  TEST_FUNCTION: testMinimalOverlayWidgetPreviewStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MinimalOverlayWidgetPreviewTest.kt
  TEST_FUNCTION: testMinimalOverlayWidgetPreviewStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/MinimalOverlayWidgetPreview.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/minimaloverlaywidgetpreview.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/MinimalOverlayWidgetPreview.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/MinimalOverlayWidgetPreviewTest.kt (NEW)
...
**Current state:** MinimalOverlayWidgetPreview exists as React Native wrapper
...
1. READ matrices/ui/molecules/MinimalOverlayWidgetPreview.md for complete style properties
