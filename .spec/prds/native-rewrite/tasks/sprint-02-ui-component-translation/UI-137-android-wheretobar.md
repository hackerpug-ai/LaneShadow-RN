================================================================================
TASK: UI-137 - WhereToBar (Android)
================================================================================
...
Implement WhereToBar component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/WhereToBar.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/WhereToBarTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: WhereToBar is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WhereToBarTest.kt
  TEST_FUNCTION: testWhereToBarDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WhereToBarTest.kt
  TEST_FUNCTION: testWhereToBarStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WhereToBarTest.kt
  TEST_FUNCTION: testWhereToBarStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/WhereToBar.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/wheretobar.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/WhereToBar.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/WhereToBarTest.kt (NEW)
...
**Current state:** WhereToBar exists as React Native wrapper
...
1. READ matrices/ui/molecules/WhereToBar.md for complete style properties
