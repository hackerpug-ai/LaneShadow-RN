================================================================================
TASK: UI-138 - WifiRequiredSheet (Android)
================================================================================
...
Implement WifiRequiredSheet component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/WifiRequiredSheet.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/WifiRequiredSheetTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: WifiRequiredSheet is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WifiRequiredSheetTest.kt
  TEST_FUNCTION: testWifiRequiredSheetDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WifiRequiredSheetTest.kt
  TEST_FUNCTION: testWifiRequiredSheetStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WifiRequiredSheetTest.kt
  TEST_FUNCTION: testWifiRequiredSheetStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/WifiRequiredSheet.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/wifirequiredsheet.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/WifiRequiredSheet.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/WifiRequiredSheetTest.kt (NEW)
...
**Current state:** WifiRequiredSheet exists as React Native wrapper
...
1. READ matrices/ui/molecules/WifiRequiredSheet.md for complete style properties
