================================================================================
TASK: UI-180 - RegionBoundsPreview (Android)
================================================================================
...
Implement RegionBoundsPreview component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RegionBoundsPreview.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RegionBoundsPreviewTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: RegionBoundsPreview is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RegionBoundsPreviewTest.kt
  TEST_FUNCTION: testRegionBoundsPreviewDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RegionBoundsPreviewTest.kt
  TEST_FUNCTION: testRegionBoundsPreviewStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RegionBoundsPreviewTest.kt
  TEST_FUNCTION: testRegionBoundsPreviewStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/templates/RegionBoundsPreview.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/regionboundspreview.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/RegionBoundsPreview.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RegionBoundsPreviewTest.kt (NEW)
...
**Current state:** RegionBoundsPreview exists as React Native wrapper
...
1. READ matrices/ui/templates/RegionBoundsPreview.md for complete style properties
