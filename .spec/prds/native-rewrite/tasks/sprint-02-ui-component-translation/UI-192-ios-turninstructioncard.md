================================================================================
TASK: UI-192 - TurnInstructionCard (Ios)
================================================================================
...
Implement TurnInstructionCard component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/TurnInstructionCard.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: TurnInstructionCardTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/TurnInstructionCard.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/TurnInstructionCardTests.swift (NEW)
