================================================================================
TASK: UI-190 - TeacherSimpleViewLayout (Ios)
================================================================================
...
Implement TeacherSimpleViewLayout component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/TeacherSimpleViewLayout.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: TeacherSimpleViewLayoutTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/TeacherSimpleViewLayout.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/TeacherSimpleViewLayoutTests.swift (NEW)
...
// SwiftUI pattern
struct TeacherSimpleViewLayout: View {
