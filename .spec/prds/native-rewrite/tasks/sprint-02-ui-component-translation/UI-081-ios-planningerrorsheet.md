================================================================================
TASK: UI-081 - PlanningErrorSheet (Ios)
================================================================================
...
Implement PlanningErrorSheet component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/PlanningErrorSheet.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: PlanningErrorSheetTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/PlanningErrorSheet.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/PlanningErrorSheetTests.swift (NEW)
...
// SwiftUI pattern
struct PlanningErrorSheet: View {
