================================================================================
TASK: UI-122 - ThemePicker (Android)
================================================================================
...
Implement ThemePicker component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/ThemePicker.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/ThemePickerTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: ThemePicker is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ThemePickerTest.kt
  TEST_FUNCTION: testThemePickerDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ThemePickerTest.kt
  TEST_FUNCTION: testThemePickerStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ThemePickerTest.kt
  TEST_FUNCTION: testThemePickerStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/ThemePicker.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/themepicker.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/ThemePicker.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/ThemePickerTest.kt (NEW)
...
**Current state:** ThemePicker exists as React Native wrapper
...
1. READ matrices/ui/molecules/ThemePicker.md for complete style properties
