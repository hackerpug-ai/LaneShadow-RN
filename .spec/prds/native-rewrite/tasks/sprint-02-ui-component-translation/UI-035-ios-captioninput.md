...
Implement CaptionInput component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/CaptionInput.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: CaptionInputTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/CaptionInput.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/CaptionInputTests.swift (NEW)
