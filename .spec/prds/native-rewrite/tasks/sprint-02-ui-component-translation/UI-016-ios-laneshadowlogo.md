================================================================================
TASK: UI-016 - LaneShadowLogo (Ios)
================================================================================
...
Implement LaneShadowLogo component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/LaneShadowLogo.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: LaneShadowLogoTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/LaneShadowLogo.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/LaneShadowLogoTests.swift (NEW)
