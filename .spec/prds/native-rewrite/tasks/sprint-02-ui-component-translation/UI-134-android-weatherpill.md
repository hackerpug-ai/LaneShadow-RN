================================================================================
TASK: UI-134 - WeatherPill (Android)
================================================================================
...
Implement WeatherPill component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/WeatherPill.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/WeatherPillTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: WeatherPill is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WeatherPillTest.kt
  TEST_FUNCTION: testWeatherPillDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WeatherPillTest.kt
  TEST_FUNCTION: testWeatherPillStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WeatherPillTest.kt
  TEST_FUNCTION: testWeatherPillStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/WeatherPill.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/weatherpill.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/WeatherPill.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/WeatherPillTest.kt (NEW)
...
**Current state:** WeatherPill exists as React Native wrapper
...
1. READ matrices/ui/molecules/WeatherPill.md for complete style properties
