================================================================================
TASK: UI-047 - DiscoveryLoadingOverlay (Ios)
================================================================================
...
Implement DiscoveryLoadingOverlay component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/DiscoveryLoadingOverlay.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: DiscoveryLoadingOverlayTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/DiscoveryLoadingOverlay.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/DiscoveryLoadingOverlayTests.swift (NEW)
