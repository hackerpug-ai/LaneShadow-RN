================================================================================
TASK: UI-130 - WaypointMarker (Android)
================================================================================
...
Implement WaypointMarker component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/WaypointMarker.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/WaypointMarkerTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: WaypointMarker is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WaypointMarkerTest.kt
  TEST_FUNCTION: testWaypointMarkerDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WaypointMarkerTest.kt
  TEST_FUNCTION: testWaypointMarkerStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WaypointMarkerTest.kt
  TEST_FUNCTION: testWaypointMarkerStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/WaypointMarker.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/waypointmarker.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/WaypointMarker.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/WaypointMarkerTest.kt (NEW)
...
**Current state:** WaypointMarker exists as React Native wrapper
...
1. READ matrices/ui/molecules/WaypointMarker.md for complete style properties
