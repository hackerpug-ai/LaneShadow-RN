================================================================================
TASK: UI-048 - DiscoverySortToggle (Ios)
================================================================================
...
Implement DiscoverySortToggle component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/DiscoverySortToggle.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: DiscoverySortToggleTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/DiscoverySortToggle.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/DiscoverySortToggleTests.swift (NEW)
