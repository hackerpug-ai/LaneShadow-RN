================================================================================
TASK: UI-174 - ErrorBoundary (Android)
================================================================================
...
Implement ErrorBoundary component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/ErrorBoundary.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/ErrorBoundaryTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: ErrorBoundary is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ErrorBoundaryTest.kt
  TEST_FUNCTION: testErrorBoundaryDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ErrorBoundaryTest.kt
  TEST_FUNCTION: testErrorBoundaryStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ErrorBoundaryTest.kt
  TEST_FUNCTION: testErrorBoundaryStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/templates/ErrorBoundary.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/errorboundary.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/ErrorBoundary.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/ErrorBoundaryTest.kt (NEW)
...
**Current state:** ErrorBoundary exists as React Native wrapper
...
1. READ matrices/ui/templates/ErrorBoundary.md for complete style properties
