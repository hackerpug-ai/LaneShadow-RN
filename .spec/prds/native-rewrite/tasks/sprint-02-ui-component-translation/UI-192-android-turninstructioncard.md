================================================================================
TASK: UI-192 - TurnInstructionCard (Android)
================================================================================
...
Implement TurnInstructionCard component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/TurnInstructionCard.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/TurnInstructionCardTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: TurnInstructionCard is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: TurnInstructionCardTest.kt
  TEST_FUNCTION: testTurnInstructionCardDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: TurnInstructionCardTest.kt
  TEST_FUNCTION: testTurnInstructionCardStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: TurnInstructionCardTest.kt
  TEST_FUNCTION: testTurnInstructionCardStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/templates/TurnInstructionCard.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/turninstructioncard.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/TurnInstructionCard.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/TurnInstructionCardTest.kt (NEW)
...
**Current state:** TurnInstructionCard exists as React Native wrapper
...
1. READ matrices/ui/templates/TurnInstructionCard.md for complete style properties
