================================================================================
TASK: UI-150 - MapViewWrapper (Android)
================================================================================
...
Implement MapViewWrapper component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/MapViewWrapper.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/MapViewWrapperTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: MapViewWrapper is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MapViewWrapperTest.kt
  TEST_FUNCTION: testMapViewWrapperDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MapViewWrapperTest.kt
  TEST_FUNCTION: testMapViewWrapperStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MapViewWrapperTest.kt
  TEST_FUNCTION: testMapViewWrapperStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/organisms/MapViewWrapper.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/mapviewwrapper.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/MapViewWrapper.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/MapViewWrapperTest.kt (NEW)
...
**Current state:** MapViewWrapper exists as React Native wrapper
...
1. READ matrices/ui/organisms/MapViewWrapper.md for complete style properties
