================================================================================
TASK: UI-127 - TypingIndicator (Ios)
================================================================================
...
Implement TypingIndicator component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/TypingIndicator.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: TypingIndicatorTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/TypingIndicator.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/TypingIndicatorTests.swift (NEW)
