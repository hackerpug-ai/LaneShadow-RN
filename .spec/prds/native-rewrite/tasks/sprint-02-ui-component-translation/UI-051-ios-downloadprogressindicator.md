================================================================================
TASK: UI-051 - DownloadProgressIndicator (Ios)
================================================================================
...
Implement DownloadProgressIndicator component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/DownloadProgressIndicator.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: DownloadProgressIndicatorTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/DownloadProgressIndicator.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/DownloadProgressIndicatorTests.swift (NEW)
