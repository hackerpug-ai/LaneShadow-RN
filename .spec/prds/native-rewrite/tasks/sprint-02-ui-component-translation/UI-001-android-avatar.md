...
Implement Avatar component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/Avatar.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/AvatarTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  TEST_FILE: AvatarTest.kt
  TEST_FUNCTION: testAvatarDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: AvatarTest.kt
  TEST_FUNCTION: testAvatarStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: AvatarTest.kt
  TEST_FUNCTION: testAvatarStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/atoms/Avatar.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/avatar.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/Avatar.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/AvatarTest.kt (NEW)
...
**Current state:** Avatar exists as React Native wrapper
...
1. READ matrices/ui/atoms/Avatar.md for complete style properties
