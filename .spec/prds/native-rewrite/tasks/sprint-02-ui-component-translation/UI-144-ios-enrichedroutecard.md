================================================================================
TASK: UI-144 - EnrichedRouteCard (Ios)
================================================================================
...
Implement EnrichedRouteCard component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/EnrichedRouteCard.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: EnrichedRouteCardTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/EnrichedRouteCard.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/EnrichedRouteCardTests.swift (NEW)
