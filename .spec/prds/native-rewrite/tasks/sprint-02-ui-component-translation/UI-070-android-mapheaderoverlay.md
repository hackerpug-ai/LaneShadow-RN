================================================================================
TASK: UI-070 - MapHeaderOverlay (Android)
================================================================================
...
Implement MapHeaderOverlay component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/MapHeaderOverlay.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/MapHeaderOverlayTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: MapHeaderOverlay is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MapHeaderOverlayTest.kt
  TEST_FUNCTION: testMapHeaderOverlayDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MapHeaderOverlayTest.kt
  TEST_FUNCTION: testMapHeaderOverlayStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MapHeaderOverlayTest.kt
  TEST_FUNCTION: testMapHeaderOverlayStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/MapHeaderOverlay.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/mapheaderoverlay.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/MapHeaderOverlay.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/MapHeaderOverlayTest.kt (NEW)
...
**Current state:** MapHeaderOverlay exists as React Native wrapper
...
1. READ matrices/ui/molecules/MapHeaderOverlay.md for complete style properties
