================================================================================
TASK: UI-044 - DepartureTimeSelector (Ios)
================================================================================
...
Implement DepartureTimeSelector component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/DepartureTimeSelector.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: DepartureTimeSelectorTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/DepartureTimeSelector.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/DepartureTimeSelectorTests.swift (NEW)
...
// SwiftUI pattern
struct DepartureTimeSelector: View {
