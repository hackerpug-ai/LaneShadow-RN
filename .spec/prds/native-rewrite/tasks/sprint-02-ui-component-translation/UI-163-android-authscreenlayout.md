================================================================================
TASK: UI-163 - AuthScreenLayout (Android)
================================================================================
...
Implement AuthScreenLayout component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/AuthScreenLayout.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/AuthScreenLayoutTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: AuthScreenLayout is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: AuthScreenLayoutTest.kt
  TEST_FUNCTION: testAuthScreenLayoutDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: AuthScreenLayoutTest.kt
  TEST_FUNCTION: testAuthScreenLayoutStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: AuthScreenLayoutTest.kt
  TEST_FUNCTION: testAuthScreenLayoutStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/screens/AuthScreenLayout.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/authscreenlayout.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/AuthScreenLayout.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/AuthScreenLayoutTest.kt (NEW)
...
**Current state:** AuthScreenLayout exists as React Native wrapper
...
1. READ matrices/ui/screens/AuthScreenLayout.md for complete style properties
