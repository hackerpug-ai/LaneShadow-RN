================================================================================
TASK: UI-166 - BottomNavigation (Android)
================================================================================
...
Implement BottomNavigation component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/BottomNavigation.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/BottomNavigationTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: BottomNavigation is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: BottomNavigationTest.kt
  TEST_FUNCTION: testBottomNavigationDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: BottomNavigationTest.kt
  TEST_FUNCTION: testBottomNavigationStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: BottomNavigationTest.kt
  TEST_FUNCTION: testBottomNavigationStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/templates/BottomNavigation.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/bottomnavigation.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/BottomNavigation.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/BottomNavigationTest.kt (NEW)
...
**Current state:** BottomNavigation exists as React Native wrapper
...
1. READ matrices/ui/templates/BottomNavigation.md for complete style properties
