================================================================================
TASK: UI-053 - EnrichmentStatusBadge (Ios)
================================================================================
...
Implement EnrichmentStatusBadge component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/EnrichmentStatusBadge.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: EnrichmentStatusBadgeTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/EnrichmentStatusBadge.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/EnrichmentStatusBadgeTests.swift (NEW)
