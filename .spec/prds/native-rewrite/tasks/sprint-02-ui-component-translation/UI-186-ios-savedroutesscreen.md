================================================================================
TASK: UI-186 - SavedRoutesScreen (Ios)
================================================================================
...
Implement SavedRoutesScreen component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/SavedRoutesScreen.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: SavedRoutesScreenTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/SavedRoutesScreen.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/SavedRoutesScreenTests.swift (NEW)
