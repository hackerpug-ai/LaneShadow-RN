================================================================================
TASK: UI-183 - RouteComparisonView (Android)
================================================================================
...
Implement RouteComparisonView component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RouteComparisonView.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RouteComparisonViewTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: RouteComparisonView is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RouteComparisonViewTest.kt
  TEST_FUNCTION: testRouteComparisonViewDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RouteComparisonViewTest.kt
  TEST_FUNCTION: testRouteComparisonViewStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RouteComparisonViewTest.kt
  TEST_FUNCTION: testRouteComparisonViewStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/templates/RouteComparisonView.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/routecomparisonview.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/RouteComparisonView.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RouteComparisonViewTest.kt (NEW)
...
**Current state:** RouteComparisonView exists as React Native wrapper
...
1. READ matrices/ui/templates/RouteComparisonView.md for complete style properties
