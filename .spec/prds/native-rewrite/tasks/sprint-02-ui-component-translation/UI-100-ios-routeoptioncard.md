================================================================================
TASK: UI-100 - RouteOptionCard (Ios)
================================================================================
...
Implement RouteOptionCard component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RouteOptionCard.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: RouteOptionCardTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/RouteOptionCard.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/RouteOptionCardTests.swift (NEW)
