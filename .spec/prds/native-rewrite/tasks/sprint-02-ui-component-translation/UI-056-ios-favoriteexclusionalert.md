================================================================================
TASK: UI-056 - FavoriteExclusionAlert (Ios)
================================================================================
...
Implement FavoriteExclusionAlert component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/FavoriteExclusionAlert.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: FavoriteExclusionAlertTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/FavoriteExclusionAlert.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/FavoriteExclusionAlertTests.swift (NEW)
...
// SwiftUI pattern
struct FavoriteExclusionAlert: View {
