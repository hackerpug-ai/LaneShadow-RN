================================================================================
TASK: UI-183 - RouteComparisonView (Ios)
================================================================================
...
Implement RouteComparisonView component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RouteComparisonView.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: RouteComparisonViewTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/RouteComparisonView.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/RouteComparisonViewTests.swift (NEW)
