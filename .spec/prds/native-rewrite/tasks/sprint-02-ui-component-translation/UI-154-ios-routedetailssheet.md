================================================================================
TASK: UI-154 - RouteDetailsSheet (Ios)
================================================================================
...
Implement RouteDetailsSheet component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RouteDetailsSheet.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: RouteDetailsSheetTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/RouteDetailsSheet.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/RouteDetailsSheetTests.swift (NEW)
