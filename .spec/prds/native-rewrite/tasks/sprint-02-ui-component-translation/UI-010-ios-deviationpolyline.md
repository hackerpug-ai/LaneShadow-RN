================================================================================
TASK: UI-010 - DeviationPolyline (Ios)
================================================================================
...
Implement DeviationPolyline component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/DeviationPolyline.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: DeviationPolylineTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/DeviationPolyline.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/DeviationPolylineTests.swift (NEW)
