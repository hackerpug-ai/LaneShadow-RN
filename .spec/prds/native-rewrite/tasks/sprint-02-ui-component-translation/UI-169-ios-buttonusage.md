...
Implement ButtonUsage component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/ButtonUsage.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: ButtonUsageTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/ButtonUsage.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/ButtonUsageTests.swift (NEW)
