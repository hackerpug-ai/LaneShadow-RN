================================================================================
TASK: UI-078 - PermissionNotification (Ios)
================================================================================
...
Implement PermissionNotification component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/PermissionNotification.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: PermissionNotificationTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/PermissionNotification.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/PermissionNotificationTests.swift (NEW)
