================================================================================
TASK: UI-129 - WaypointCard (Android)
================================================================================
...
Implement WaypointCard component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/WaypointCard.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/WaypointCardTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: WaypointCard is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WaypointCardTest.kt
  TEST_FUNCTION: testWaypointCardDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WaypointCardTest.kt
  TEST_FUNCTION: testWaypointCardStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WaypointCardTest.kt
  TEST_FUNCTION: testWaypointCardStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/WaypointCard.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/waypointcard.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/WaypointCard.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/WaypointCardTest.kt (NEW)
...
**Current state:** WaypointCard exists as React Native wrapper
...
1. READ matrices/ui/molecules/WaypointCard.md for complete style properties
