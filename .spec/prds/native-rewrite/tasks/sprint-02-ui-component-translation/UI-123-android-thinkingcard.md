================================================================================
TASK: UI-123 - ThinkingCard (Android)
================================================================================
...
Implement ThinkingCard component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/ThinkingCard.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/ThinkingCardTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: ThinkingCard is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ThinkingCardTest.kt
  TEST_FUNCTION: testThinkingCardDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ThinkingCardTest.kt
  TEST_FUNCTION: testThinkingCardStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ThinkingCardTest.kt
  TEST_FUNCTION: testThinkingCardStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/ThinkingCard.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/thinkingcard.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/ThinkingCard.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/ThinkingCardTest.kt (NEW)
...
**Current state:** ThinkingCard exists as React Native wrapper
...
1. READ matrices/ui/molecules/ThinkingCard.md for complete style properties
