================================================================================
TASK: UI-029 - ThemedView (Android)
================================================================================
...
Implement ThemedView component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/ThemedView.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/ThemedViewTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: ThemedView is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ThemedViewTest.kt
  TEST_FUNCTION: testThemedViewDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ThemedViewTest.kt
  TEST_FUNCTION: testThemedViewStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ThemedViewTest.kt
  TEST_FUNCTION: testThemedViewStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/atoms/ThemedView.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/themedview.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/ThemedView.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/ThemedViewTest.kt (NEW)
...
**Current state:** ThemedView exists as React Native wrapper
...
1. READ matrices/ui/atoms/ThemedView.md for complete style properties
