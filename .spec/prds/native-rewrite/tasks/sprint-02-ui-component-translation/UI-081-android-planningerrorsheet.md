================================================================================
TASK: UI-081 - PlanningErrorSheet (Android)
================================================================================
...
Implement PlanningErrorSheet component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/PlanningErrorSheet.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/PlanningErrorSheetTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: PlanningErrorSheet is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: PlanningErrorSheetTest.kt
  TEST_FUNCTION: testPlanningErrorSheetDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: PlanningErrorSheetTest.kt
  TEST_FUNCTION: testPlanningErrorSheetStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: PlanningErrorSheetTest.kt
  TEST_FUNCTION: testPlanningErrorSheetStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/PlanningErrorSheet.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/planningerrorsheet.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/PlanningErrorSheet.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/PlanningErrorSheetTest.kt (NEW)
...
**Current state:** PlanningErrorSheet exists as React Native wrapper
...
1. READ matrices/ui/molecules/PlanningErrorSheet.md for complete style properties
