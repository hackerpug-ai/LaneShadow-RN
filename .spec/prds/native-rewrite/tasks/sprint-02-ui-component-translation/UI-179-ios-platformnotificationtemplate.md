================================================================================
TASK: UI-179 - PlatformNotificationTemplate (Ios)
================================================================================
...
Implement PlatformNotificationTemplate component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/PlatformNotificationTemplate.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: PlatformNotificationTemplateTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/PlatformNotificationTemplate.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/PlatformNotificationTemplateTests.swift (NEW)
...
// SwiftUI pattern
struct PlatformNotificationTemplate: View {
