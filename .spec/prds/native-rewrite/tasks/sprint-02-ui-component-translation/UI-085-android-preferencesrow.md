================================================================================
TASK: UI-085 - PreferencesRow (Android)
================================================================================
...
Implement PreferencesRow component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/PreferencesRow.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/PreferencesRowTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: PreferencesRow is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: PreferencesRowTest.kt
  TEST_FUNCTION: testPreferencesRowDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: PreferencesRowTest.kt
  TEST_FUNCTION: testPreferencesRowStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: PreferencesRowTest.kt
  TEST_FUNCTION: testPreferencesRowStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/PreferencesRow.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/preferencesrow.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/PreferencesRow.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/PreferencesRowTest.kt (NEW)
...
**Current state:** PreferencesRow exists as React Native wrapper
...
1. READ matrices/ui/molecules/PreferencesRow.md for complete style properties
