================================================================================
TASK: UI-119 - TeacherTabBar (Android)
================================================================================
...
Implement TeacherTabBar component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/TeacherTabBar.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/TeacherTabBarTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: TeacherTabBar is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: TeacherTabBarTest.kt
  TEST_FUNCTION: testTeacherTabBarDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: TeacherTabBarTest.kt
  TEST_FUNCTION: testTeacherTabBarStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: TeacherTabBarTest.kt
  TEST_FUNCTION: testTeacherTabBarStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/TeacherTabBar.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/teachertabbar.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/TeacherTabBar.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/TeacherTabBarTest.kt (NEW)
...
**Current state:** TeacherTabBar exists as React Native wrapper
...
1. READ matrices/ui/molecules/TeacherTabBar.md for complete style properties
