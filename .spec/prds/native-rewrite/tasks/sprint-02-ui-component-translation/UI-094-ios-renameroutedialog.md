================================================================================
TASK: UI-094 - RenameRouteDialog (Ios)
================================================================================
...
Implement RenameRouteDialog component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RenameRouteDialog.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: RenameRouteDialogTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/RenameRouteDialog.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/RenameRouteDialogTests.swift (NEW)
