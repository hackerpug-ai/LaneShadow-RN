...
Implement OverlayPill component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/OverlayPill.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: OverlayPillTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/OverlayPill.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/OverlayPillTests.swift (NEW)
