================================================================================
TASK: UI-038 - ConnectionBanner (Ios)
================================================================================
...
Implement ConnectionBanner component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/ConnectionBanner.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: ConnectionBannerTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/ConnectionBanner.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/ConnectionBannerTests.swift (NEW)
