================================================================================
TASK: UI-166 - BottomNavigation (Ios)
================================================================================
...
Implement BottomNavigation component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/BottomNavigation.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: BottomNavigationTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/BottomNavigation.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/BottomNavigationTests.swift (NEW)
