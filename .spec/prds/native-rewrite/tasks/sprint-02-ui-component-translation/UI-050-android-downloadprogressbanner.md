================================================================================
TASK: UI-050 - DownloadProgressBanner (Android)
================================================================================
...
Implement DownloadProgressBanner component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/DownloadProgressBanner.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/DownloadProgressBannerTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: DownloadProgressBanner is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: DownloadProgressBannerTest.kt
  TEST_FUNCTION: testDownloadProgressBannerDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: DownloadProgressBannerTest.kt
  TEST_FUNCTION: testDownloadProgressBannerStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: DownloadProgressBannerTest.kt
  TEST_FUNCTION: testDownloadProgressBannerStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/DownloadProgressBanner.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/downloadprogressbanner.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/DownloadProgressBanner.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/DownloadProgressBannerTest.kt (NEW)
...
**Current state:** DownloadProgressBanner exists as React Native wrapper
...
1. READ matrices/ui/molecules/DownloadProgressBanner.md for complete style properties
