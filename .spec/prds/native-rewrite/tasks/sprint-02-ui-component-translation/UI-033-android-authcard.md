...
Implement AuthCard component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/AuthCard.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/AuthCardTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: AuthCard is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: AuthCardTest.kt
  TEST_FUNCTION: testAuthCardDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: AuthCardTest.kt
  TEST_FUNCTION: testAuthCardStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: AuthCardTest.kt
  TEST_FUNCTION: testAuthCardStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/AuthCard.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/authcard.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/AuthCard.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/AuthCardTest.kt (NEW)
...
**Current state:** AuthCard exists as React Native wrapper
...
1. READ matrices/ui/molecules/AuthCard.md for complete style properties
