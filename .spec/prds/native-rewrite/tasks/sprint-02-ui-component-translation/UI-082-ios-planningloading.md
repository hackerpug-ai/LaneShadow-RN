================================================================================
TASK: UI-082 - PlanningLoading (Ios)
================================================================================
...
Implement PlanningLoading component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/PlanningLoading.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: PlanningLoadingTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/PlanningLoading.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/PlanningLoadingTests.swift (NEW)
