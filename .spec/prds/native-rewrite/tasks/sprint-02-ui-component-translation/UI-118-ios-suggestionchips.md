================================================================================
TASK: UI-118 - SuggestionChips (Ios)
================================================================================
...
Implement SuggestionChips component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/SuggestionChips.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: SuggestionChipsTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/SuggestionChips.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/SuggestionChipsTests.swift (NEW)
