================================================================================
TASK: UI-093 - RenameRegionBottomSheet (Ios)
================================================================================
...
Implement RenameRegionBottomSheet component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RenameRegionBottomSheet.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: RenameRegionBottomSheetTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/RenameRegionBottomSheet.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/RenameRegionBottomSheetTests.swift (NEW)
