================================================================================
TASK: UI-091 - RegionListItem (Android)
================================================================================
...
Implement RegionListItem component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RegionListItem.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RegionListItemTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: RegionListItem is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RegionListItemTest.kt
  TEST_FUNCTION: testRegionListItemDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RegionListItemTest.kt
  TEST_FUNCTION: testRegionListItemStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RegionListItemTest.kt
  TEST_FUNCTION: testRegionListItemStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/RegionListItem.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/regionlistitem.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/RegionListItem.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RegionListItemTest.kt (NEW)
...
**Current state:** RegionListItem exists as React Native wrapper
...
1. READ matrices/ui/molecules/RegionListItem.md for complete style properties
