...
Implement Chip component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/Chip.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/ChipTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  TEST_FILE: ChipTest.kt
  TEST_FUNCTION: testChipDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ChipTest.kt
  TEST_FUNCTION: testChipStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ChipTest.kt
  TEST_FUNCTION: testChipStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/atoms/Chip.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/chip.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/Chip.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/ChipTest.kt (NEW)
...
**Current state:** Chip exists as React Native wrapper
...
1. READ matrices/ui/atoms/Chip.md for complete style properties
