================================================================================
TASK: UI-045 - DiscoveryEmptyOverlay (Ios)
================================================================================
...
Implement DiscoveryEmptyOverlay component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/DiscoveryEmptyOverlay.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: DiscoveryEmptyOverlayTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/DiscoveryEmptyOverlay.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/DiscoveryEmptyOverlayTests.swift (NEW)
