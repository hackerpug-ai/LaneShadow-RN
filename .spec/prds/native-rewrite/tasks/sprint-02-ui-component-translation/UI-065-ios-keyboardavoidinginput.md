================================================================================
TASK: UI-065 - KeyboardAvoidingInput (Ios)
================================================================================
...
Implement KeyboardAvoidingInput component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/KeyboardAvoidingInput.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: KeyboardAvoidingInputTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/KeyboardAvoidingInput.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/KeyboardAvoidingInputTests.swift (NEW)
...
// SwiftUI pattern
struct KeyboardAvoidingInput: View {
