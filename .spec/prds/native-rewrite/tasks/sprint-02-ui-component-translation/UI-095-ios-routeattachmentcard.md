================================================================================
TASK: UI-095 - RouteAttachmentCard (Ios)
================================================================================
...
Implement RouteAttachmentCard component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RouteAttachmentCard.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: RouteAttachmentCardTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/RouteAttachmentCard.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/RouteAttachmentCardTests.swift (NEW)
...
// SwiftUI pattern
struct RouteAttachmentCard: View {
