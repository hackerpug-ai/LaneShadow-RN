================================================================================
TASK: UI-099 - RouteOptionCard-Planning (Android)
================================================================================
...
Implement RouteOptionCard-Planning component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RouteOptionCard-Planning.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RouteOptionCard-PlanningTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: RouteOptionCard-Planning is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RouteOptionCard-PlanningTest.kt
  TEST_FUNCTION: testRouteOptionCard-PlanningDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RouteOptionCard-PlanningTest.kt
  TEST_FUNCTION: testRouteOptionCard-PlanningStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RouteOptionCard-PlanningTest.kt
  TEST_FUNCTION: testRouteOptionCard-PlanningStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/RouteOptionCard-Planning.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/routeoptioncard-planning.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/RouteOptionCard-Planning.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RouteOptionCard-PlanningTest.kt (NEW)
...
**Current state:** RouteOptionCard-Planning exists as React Native wrapper
...
1. READ matrices/ui/molecules/RouteOptionCard-Planning.md for complete style properties
