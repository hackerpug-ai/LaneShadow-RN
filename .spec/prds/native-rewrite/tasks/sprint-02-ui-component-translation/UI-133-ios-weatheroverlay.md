================================================================================
TASK: UI-133 - WeatherOverlay (Ios)
================================================================================
...
Implement WeatherOverlay component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/WeatherOverlay.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: WeatherOverlayTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/WeatherOverlay.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/WeatherOverlayTests.swift (NEW)
