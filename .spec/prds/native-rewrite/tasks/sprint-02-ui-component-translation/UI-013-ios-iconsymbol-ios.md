================================================================================
TASK: UI-013 - IconSymbol-iOS (Ios)
================================================================================
...
Implement IconSymbol-iOS component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/IconSymbol-iOS.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: IconSymbol-iOSTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/IconSymbol-iOS.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/IconSymbol-iOSTests.swift (NEW)
