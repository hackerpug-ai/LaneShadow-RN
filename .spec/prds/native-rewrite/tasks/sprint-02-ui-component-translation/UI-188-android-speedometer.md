================================================================================
TASK: UI-188 - Speedometer (Android)
================================================================================
...
Implement Speedometer component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/Speedometer.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/SpeedometerTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: Speedometer is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: SpeedometerTest.kt
  TEST_FUNCTION: testSpeedometerDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: SpeedometerTest.kt
  TEST_FUNCTION: testSpeedometerStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: SpeedometerTest.kt
  TEST_FUNCTION: testSpeedometerStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/templates/Speedometer.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/speedometer.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/Speedometer.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/SpeedometerTest.kt (NEW)
...
**Current state:** Speedometer exists as React Native wrapper
...
1. READ matrices/ui/templates/Speedometer.md for complete style properties
