================================================================================
TASK: UI-085 - PreferencesRow (Ios)
================================================================================
...
Implement PreferencesRow component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/PreferencesRow.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: PreferencesRowTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/PreferencesRow.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/PreferencesRowTests.swift (NEW)
