================================================================================
TASK: UI-046 - DiscoveryFilterBar (Ios)
================================================================================
...
Implement DiscoveryFilterBar component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/DiscoveryFilterBar.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: DiscoveryFilterBarTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/DiscoveryFilterBar.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/DiscoveryFilterBarTests.swift (NEW)
...
// SwiftUI pattern
struct DiscoveryFilterBar: View {
