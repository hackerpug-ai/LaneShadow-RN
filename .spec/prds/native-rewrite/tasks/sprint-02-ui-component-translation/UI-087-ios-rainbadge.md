...
Implement RainBadge component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RainBadge.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: RainBadgeTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/RainBadge.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/RainBadgeTests.swift (NEW)
