================================================================================
TASK: UI-126 - TopographicBackground (Ios)
================================================================================
...
Implement TopographicBackground component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/TopographicBackground.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: TopographicBackgroundTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/TopographicBackground.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/TopographicBackgroundTests.swift (NEW)
