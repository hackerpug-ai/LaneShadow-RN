================================================================================
TASK: UI-112 - SessionContextMenu (Ios)
================================================================================
...
Implement SessionContextMenu component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/SessionContextMenu.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: SessionContextMenuTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/SessionContextMenu.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/SessionContextMenuTests.swift (NEW)
