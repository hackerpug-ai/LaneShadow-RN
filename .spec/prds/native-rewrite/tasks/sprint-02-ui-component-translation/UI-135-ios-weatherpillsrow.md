================================================================================
TASK: UI-135 - WeatherPillsRow (Ios)
================================================================================
...
Implement WeatherPillsRow component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/WeatherPillsRow.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: WeatherPillsRowTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/WeatherPillsRow.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/WeatherPillsRowTests.swift (NEW)
