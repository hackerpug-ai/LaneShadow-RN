================================================================================
TASK: UI-106 - ScenicBiasSegmented (Android)
================================================================================
...
Implement ScenicBiasSegmented component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/ScenicBiasSegmented.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/ScenicBiasSegmentedTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: ScenicBiasSegmented is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ScenicBiasSegmentedTest.kt
  TEST_FUNCTION: testScenicBiasSegmentedDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ScenicBiasSegmentedTest.kt
  TEST_FUNCTION: testScenicBiasSegmentedStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ScenicBiasSegmentedTest.kt
  TEST_FUNCTION: testScenicBiasSegmentedStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/ScenicBiasSegmented.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/scenicbiassegmented.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/ScenicBiasSegmented.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/ScenicBiasSegmentedTest.kt (NEW)
...
**Current state:** ScenicBiasSegmented exists as React Native wrapper
...
1. READ matrices/ui/molecules/ScenicBiasSegmented.md for complete style properties
