================================================================================
TASK: UI-175 - GatekeeperUpgradePrompt (Android)
================================================================================
...
Implement GatekeeperUpgradePrompt component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/GatekeeperUpgradePrompt.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/GatekeeperUpgradePromptTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: GatekeeperUpgradePrompt is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: GatekeeperUpgradePromptTest.kt
  TEST_FUNCTION: testGatekeeperUpgradePromptDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: GatekeeperUpgradePromptTest.kt
  TEST_FUNCTION: testGatekeeperUpgradePromptStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: GatekeeperUpgradePromptTest.kt
  TEST_FUNCTION: testGatekeeperUpgradePromptStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/templates/GatekeeperUpgradePrompt.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/gatekeeperupgradeprompt.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/GatekeeperUpgradePrompt.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/GatekeeperUpgradePromptTest.kt (NEW)
...
**Current state:** GatekeeperUpgradePrompt exists as React Native wrapper
...
1. READ matrices/ui/templates/GatekeeperUpgradePrompt.md for complete style properties
