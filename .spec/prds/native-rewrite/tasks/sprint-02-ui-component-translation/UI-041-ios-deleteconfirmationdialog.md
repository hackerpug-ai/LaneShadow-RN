================================================================================
TASK: UI-041 - DeleteConfirmationDialog (Ios)
================================================================================
...
Implement DeleteConfirmationDialog component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/DeleteConfirmationDialog.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: DeleteConfirmationDialogTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/DeleteConfirmationDialog.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/DeleteConfirmationDialogTests.swift (NEW)
