...
Implement Checkbox component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/Checkbox.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/CheckboxTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: Checkbox is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: CheckboxTest.kt
  TEST_FUNCTION: testCheckboxDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: CheckboxTest.kt
  TEST_FUNCTION: testCheckboxStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: CheckboxTest.kt
  TEST_FUNCTION: testCheckboxStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/atoms/Checkbox.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/checkbox.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/Checkbox.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/CheckboxTest.kt (NEW)
...
**Current state:** Checkbox exists as React Native wrapper
...
1. READ matrices/ui/atoms/Checkbox.md for complete style properties
