...
Implement InfoToast component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/InfoToast.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: InfoToastTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/InfoToast.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/InfoToastTests.swift (NEW)
