...
Implement WaypointCard component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/WaypointCard.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: WaypointCardTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/WaypointCard.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/WaypointCardTests.swift (NEW)
