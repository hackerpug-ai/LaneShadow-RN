================================================================================
TASK: UI-089 - RationaleReveal (Ios)
================================================================================
...
Implement RationaleReveal component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RationaleReveal.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: RationaleRevealTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/RationaleReveal.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/RationaleRevealTests.swift (NEW)
