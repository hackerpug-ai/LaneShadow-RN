================================================================================
TASK: UI-178 - ModelGatekeeperProvider (Ios)
================================================================================
...
Implement ModelGatekeeperProvider component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/ModelGatekeeperProvider.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: ModelGatekeeperProviderTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/ModelGatekeeperProvider.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/ModelGatekeeperProviderTests.swift (NEW)
...
// SwiftUI pattern
struct ModelGatekeeperProvider: View {
