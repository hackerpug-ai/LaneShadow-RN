================================================================================
TASK: UI-069 - MapControls (Android)
================================================================================
...
Implement MapControls component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/MapControls.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/MapControlsTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: MapControls is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MapControlsTest.kt
  TEST_FUNCTION: testMapControlsDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MapControlsTest.kt
  TEST_FUNCTION: testMapControlsStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MapControlsTest.kt
  TEST_FUNCTION: testMapControlsStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/MapControls.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/mapcontrols.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/MapControls.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/MapControlsTest.kt (NEW)
...
**Current state:** MapControls exists as React Native wrapper
...
1. READ matrices/ui/molecules/MapControls.md for complete style properties
