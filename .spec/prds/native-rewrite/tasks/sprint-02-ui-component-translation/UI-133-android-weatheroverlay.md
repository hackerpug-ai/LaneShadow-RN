================================================================================
TASK: UI-133 - WeatherOverlay (Android)
================================================================================
...
Implement WeatherOverlay component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/WeatherOverlay.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/WeatherOverlayTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: WeatherOverlay is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WeatherOverlayTest.kt
  TEST_FUNCTION: testWeatherOverlayDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WeatherOverlayTest.kt
  TEST_FUNCTION: testWeatherOverlayStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WeatherOverlayTest.kt
  TEST_FUNCTION: testWeatherOverlayStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/WeatherOverlay.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/weatheroverlay.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/WeatherOverlay.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/WeatherOverlayTest.kt (NEW)
...
**Current state:** WeatherOverlay exists as React Native wrapper
...
1. READ matrices/ui/molecules/WeatherOverlay.md for complete style properties
