================================================================================
TASK: UI-091 - RegionListItem (Ios)
================================================================================
...
Implement RegionListItem component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RegionListItem.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: RegionListItemTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/RegionListItem.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/RegionListItemTests.swift (NEW)
