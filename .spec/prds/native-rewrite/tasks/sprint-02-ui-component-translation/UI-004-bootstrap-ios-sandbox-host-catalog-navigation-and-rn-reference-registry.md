...
**THEN** The listed components or compositions exist in the correct iOS SwiftUI directories with parity-aligned names and signatures: Bootstrap iOS sandbox host, catalog navigation, and RN reference registry.
