================================================================================
TASK: UI-168 - BoundingBoxOverlay (Ios)
================================================================================
...
Implement BoundingBoxOverlay component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/BoundingBoxOverlay.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: BoundingBoxOverlayTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/BoundingBoxOverlay.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/BoundingBoxOverlayTests.swift (NEW)
