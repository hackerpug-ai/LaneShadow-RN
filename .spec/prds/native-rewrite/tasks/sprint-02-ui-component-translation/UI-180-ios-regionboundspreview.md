================================================================================
TASK: UI-180 - RegionBoundsPreview (Ios)
================================================================================
...
Implement RegionBoundsPreview component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RegionBoundsPreview.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: RegionBoundsPreviewTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/RegionBoundsPreview.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/RegionBoundsPreviewTests.swift (NEW)
...
// SwiftUI pattern
struct RegionBoundsPreview: View {
