================================================================================
TASK: UI-128 - WarningToast (Android)
================================================================================
...
Implement WarningToast component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/WarningToast.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/WarningToastTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: WarningToast is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WarningToastTest.kt
  TEST_FUNCTION: testWarningToastDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WarningToastTest.kt
  TEST_FUNCTION: testWarningToastStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WarningToastTest.kt
  TEST_FUNCTION: testWarningToastStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/WarningToast.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/warningtoast.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/WarningToast.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/WarningToastTest.kt (NEW)
...
**Current state:** WarningToast exists as React Native wrapper
...
1. READ matrices/ui/molecules/WarningToast.md for complete style properties
