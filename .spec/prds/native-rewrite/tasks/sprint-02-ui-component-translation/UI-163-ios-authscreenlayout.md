================================================================================
TASK: UI-163 - AuthScreenLayout (Ios)
================================================================================
...
Implement AuthScreenLayout component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/AuthScreenLayout.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: AuthScreenLayoutTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/AuthScreenLayout.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/AuthScreenLayoutTests.swift (NEW)
