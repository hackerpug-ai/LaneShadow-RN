================================================================================
TASK: UI-099 - RouteOptionCard-Planning (Ios)
================================================================================
...
Implement RouteOptionCard-Planning component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RouteOptionCard-Planning.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: RouteOptionCard-PlanningTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/RouteOptionCard-Planning.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/RouteOptionCard-PlanningTests.swift (NEW)
...
// SwiftUI pattern
struct RouteOptionCard-Planning: View {
