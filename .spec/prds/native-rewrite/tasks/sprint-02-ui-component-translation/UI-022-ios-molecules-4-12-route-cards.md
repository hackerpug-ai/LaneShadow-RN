# UI-022: iOS molecules 4/12 — route cards (all): `ThemeRouteThumbnail`, `RouteBadge`, `ThemeRouteOptionCard` (x2), `ThemeSessionCard`, `ThemeSavedRouteCard`, `ThemeFavoriteRoadCard`, `ThemeRouteAttachmentCard` (x2), `ThemeRouteLegTimeline`, `RoutePin`, `ThemeWaypointCard`
...
Sprint 2 translates the React Native baseline into native platform components and sandbox scenarios before rider-facing feature sprints resume. This task covers the `molecules` slice for `iOS molecules 4/12 — route cards (all): ThemeRouteThumbnail, RouteBadge, ThemeRouteOptionCard (x2), ThemeSessionCard, ThemeSavedRouteCard, ThemeFavoriteRoadCard, ThemeRouteAttachmentCard (x2), ThemeRouteLegTimeline, RoutePin, ThemeWaypointCard`.

**Objective:** Implement iOS molecules 4/12 — route cards (all): `ThemeRouteThumbnail`, `RouteBadge`, `ThemeRouteOptionCard` (x2), `ThemeSessionCard`, `ThemeSavedRouteCard`, `ThemeFavoriteRoadCard`, `ThemeRouteAttachmentCard` (x2), `ThemeRouteLegTimeline`, `RoutePin`, `ThemeWaypointCard` as SwiftUI work with parity to the RN baseline, token-only styling, and sandbox coverage.
...
### MUST
- Implement the listed components or compositions with parity-aligned naming and interfaces: `ThemeRouteThumbnail`, `RouteBadge`, `ThemeRouteOptionCard` (x2), `ThemeSessionCard`, `ThemeSavedRouteCard`, `ThemeFavoriteRoadCard`, `ThemeRouteAttachmentCard` (x2), `ThemeRouteLegTimeline`, `RoutePin`, `ThemeWaypointCard`.
...
**THEN** The listed components or compositions exist in the correct iOS SwiftUI directories with parity-aligned names and signatures: `ThemeRouteThumbnail`, `RouteBadge`, `ThemeRouteOptionCard` (x2), `ThemeSessionCard`, `ThemeSavedRouteCard`, `ThemeFavoriteRoadCard`, `ThemeRouteAttachmentCard` (x2), `ThemeRouteLegTimeline`, `RoutePin`, `ThemeWaypointCard`.
**Verify:** `printf "%s\n" "`ThemeRouteThumbnail`, `RouteBadge`, `ThemeRouteOptionCard` (x2), `ThemeSessionCard`, `ThemeSavedRouteCard`, `ThemeFavoriteRoadCard`, `ThemeRouteAttachmentCard` (x2), `ThemeRouteLegTimeline`, `RoutePin`, `ThemeWaypointCard`"`
...
|---|---|---|---|
| TC-1 | AC-1 | The listed components or compositions exist in the correct iOS SwiftUI directories with parity-aligned names and signatures: `ThemeRouteThumbnail`, `RouteBadge`, `ThemeRouteOptionCard` (x2), `ThemeSessionCard`, `ThemeSavedRouteCard`, `ThemeFavoriteRoadCard`, `ThemeRouteAttachmentCard` (x2), `ThemeRouteLegTimeline`, `RoutePin`, `ThemeWaypointCard`. | `printf "%s\n" "`ThemeRouteThumbnail`, `RouteBadge`, `ThemeRouteOptionCard` (x2), `ThemeSessionCard`, `ThemeSavedRouteCard`, `ThemeFavoriteRoadCard`, `ThemeRouteAttachmentCard` (x2), `ThemeRouteLegTimeline`, `RoutePin`, `ThemeWaypointCard`"` |
