...
Implement MapControls component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/MapControls.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: MapControlsTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/MapControls.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/MapControlsTests.swift (NEW)
