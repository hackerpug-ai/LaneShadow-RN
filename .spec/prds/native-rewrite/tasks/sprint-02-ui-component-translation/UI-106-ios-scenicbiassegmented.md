================================================================================
TASK: UI-106 - ScenicBiasSegmented (Ios)
================================================================================
...
Implement ScenicBiasSegmented component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/ScenicBiasSegmented.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: ScenicBiasSegmentedTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/ScenicBiasSegmented.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/ScenicBiasSegmentedTests.swift (NEW)
...
// SwiftUI pattern
struct ScenicBiasSegmented: View {
