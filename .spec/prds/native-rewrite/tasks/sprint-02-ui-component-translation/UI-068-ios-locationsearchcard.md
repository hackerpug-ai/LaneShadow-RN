================================================================================
TASK: UI-068 - LocationSearchCard (Ios)
================================================================================
...
Implement LocationSearchCard component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/LocationSearchCard.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: LocationSearchCardTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/LocationSearchCard.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/LocationSearchCardTests.swift (NEW)
