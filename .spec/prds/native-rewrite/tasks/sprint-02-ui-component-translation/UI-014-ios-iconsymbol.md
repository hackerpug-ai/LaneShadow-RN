...
Implement IconSymbol component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/IconSymbol.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: IconSymbolTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/IconSymbol.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/IconSymbolTests.swift (NEW)
