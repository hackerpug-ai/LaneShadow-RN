================================================================================
TASK: UI-193 - VoiceListeningVisualizer (Ios)
================================================================================
...
Implement VoiceListeningVisualizer component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/VoiceListeningVisualizer.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: VoiceListeningVisualizerTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/VoiceListeningVisualizer.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/VoiceListeningVisualizerTests.swift (NEW)
...
// SwiftUI pattern
struct VoiceListeningVisualizer: View {
