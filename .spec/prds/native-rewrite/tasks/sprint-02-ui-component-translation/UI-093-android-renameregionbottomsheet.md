================================================================================
TASK: UI-093 - RenameRegionBottomSheet (Android)
================================================================================
...
Implement RenameRegionBottomSheet component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RenameRegionBottomSheet.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RenameRegionBottomSheetTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: RenameRegionBottomSheet is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RenameRegionBottomSheetTest.kt
  TEST_FUNCTION: testRenameRegionBottomSheetDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RenameRegionBottomSheetTest.kt
  TEST_FUNCTION: testRenameRegionBottomSheetStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RenameRegionBottomSheetTest.kt
  TEST_FUNCTION: testRenameRegionBottomSheetStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/RenameRegionBottomSheet.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/renameregionbottomsheet.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/RenameRegionBottomSheet.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RenameRegionBottomSheetTest.kt (NEW)
...
**Current state:** RenameRegionBottomSheet exists as React Native wrapper
...
1. READ matrices/ui/molecules/RenameRegionBottomSheet.md for complete style properties
