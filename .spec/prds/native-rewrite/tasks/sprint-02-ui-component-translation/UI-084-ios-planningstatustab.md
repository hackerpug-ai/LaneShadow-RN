================================================================================
TASK: UI-084 - PlanningStatusTab (Ios)
================================================================================
...
Implement PlanningStatusTab component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/PlanningStatusTab.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: PlanningStatusTabTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/PlanningStatusTab.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/PlanningStatusTabTests.swift (NEW)
