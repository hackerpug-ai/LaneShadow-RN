================================================================================
TASK: UI-047 - DiscoveryLoadingOverlay (Android)
================================================================================
...
Implement DiscoveryLoadingOverlay component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/DiscoveryLoadingOverlay.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/DiscoveryLoadingOverlayTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: DiscoveryLoadingOverlay is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: DiscoveryLoadingOverlayTest.kt
  TEST_FUNCTION: testDiscoveryLoadingOverlayDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: DiscoveryLoadingOverlayTest.kt
  TEST_FUNCTION: testDiscoveryLoadingOverlayStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: DiscoveryLoadingOverlayTest.kt
  TEST_FUNCTION: testDiscoveryLoadingOverlayStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/DiscoveryLoadingOverlay.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/discoveryloadingoverlay.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/DiscoveryLoadingOverlay.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/DiscoveryLoadingOverlayTest.kt (NEW)
...
**Current state:** DiscoveryLoadingOverlay exists as React Native wrapper
...
1. READ matrices/ui/molecules/DiscoveryLoadingOverlay.md for complete style properties
