================================================================================
TASK: UI-057 - FavoriteRoadCard (Ios)
================================================================================
...
Implement FavoriteRoadCard component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/FavoriteRoadCard.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: FavoriteRoadCardTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/FavoriteRoadCard.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/FavoriteRoadCardTests.swift (NEW)
