...
Implement WindBadge component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/WindBadge.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: WindBadgeTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/WindBadge.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/WindBadgeTests.swift (NEW)
