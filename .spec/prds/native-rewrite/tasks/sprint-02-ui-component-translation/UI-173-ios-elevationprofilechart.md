================================================================================
TASK: UI-173 - ElevationProfileChart (Ios)
================================================================================
...
Implement ElevationProfileChart component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/ElevationProfileChart.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: ElevationProfileChartTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/ElevationProfileChart.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/ElevationProfileChartTests.swift (NEW)
