================================================================================
TASK: UI-148 - MapboxMapView (Android)
================================================================================
...
Implement MapboxMapView component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/MapboxMapView.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/MapboxMapViewTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: MapboxMapView is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MapboxMapViewTest.kt
  TEST_FUNCTION: testMapboxMapViewDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MapboxMapViewTest.kt
  TEST_FUNCTION: testMapboxMapViewStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MapboxMapViewTest.kt
  TEST_FUNCTION: testMapboxMapViewStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/organisms/MapboxMapView.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/mapboxmapview.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/MapboxMapView.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/MapboxMapViewTest.kt (NEW)
...
**Current state:** MapboxMapView exists as React Native wrapper
...
1. READ matrices/ui/organisms/MapboxMapView.md for complete style properties
