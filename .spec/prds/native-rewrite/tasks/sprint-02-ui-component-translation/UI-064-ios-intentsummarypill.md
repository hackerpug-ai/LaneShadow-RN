================================================================================
TASK: UI-064 - IntentSummaryPill (Ios)
================================================================================
...
Implement IntentSummaryPill component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/IntentSummaryPill.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: IntentSummaryPillTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/IntentSummaryPill.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/IntentSummaryPillTests.swift (NEW)
