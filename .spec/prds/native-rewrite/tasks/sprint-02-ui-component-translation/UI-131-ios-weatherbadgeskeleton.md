================================================================================
TASK: UI-131 - WeatherBadgeSkeleton (Ios)
================================================================================
...
Implement WeatherBadgeSkeleton component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/WeatherBadgeSkeleton.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: WeatherBadgeSkeletonTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/WeatherBadgeSkeleton.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/WeatherBadgeSkeletonTests.swift (NEW)
