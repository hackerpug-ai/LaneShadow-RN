================================================================================
TASK: UI-008 - Collapsible (Android)
================================================================================
...
Implement Collapsible component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/Collapsible.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/CollapsibleTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: Collapsible is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: CollapsibleTest.kt
  TEST_FUNCTION: testCollapsibleDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: CollapsibleTest.kt
  TEST_FUNCTION: testCollapsibleStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: CollapsibleTest.kt
  TEST_FUNCTION: testCollapsibleStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/atoms/Collapsible.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/collapsible.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/Collapsible.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/CollapsibleTest.kt (NEW)
...
**Current state:** Collapsible exists as React Native wrapper
...
1. READ matrices/ui/atoms/Collapsible.md for complete style properties
