...
Implement RainBadge component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RainBadge.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RainBadgeTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: RainBadge is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RainBadgeTest.kt
  TEST_FUNCTION: testRainBadgeDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RainBadgeTest.kt
  TEST_FUNCTION: testRainBadgeStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RainBadgeTest.kt
  TEST_FUNCTION: testRainBadgeStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/RainBadge.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/rainbadge.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/RainBadge.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RainBadgeTest.kt (NEW)
...
**Current state:** RainBadge exists as React Native wrapper
...
1. READ matrices/ui/molecules/RainBadge.md for complete style properties
