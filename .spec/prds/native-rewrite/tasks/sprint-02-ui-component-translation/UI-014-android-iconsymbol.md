================================================================================
TASK: UI-014 - IconSymbol (Android)
================================================================================
...
Implement IconSymbol component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/IconSymbol.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/IconSymbolTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: IconSymbol is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: IconSymbolTest.kt
  TEST_FUNCTION: testIconSymbolDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: IconSymbolTest.kt
  TEST_FUNCTION: testIconSymbolStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: IconSymbolTest.kt
  TEST_FUNCTION: testIconSymbolStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/atoms/IconSymbol.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/iconsymbol.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/IconSymbol.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/IconSymbolTest.kt (NEW)
...
**Current state:** IconSymbol exists as React Native wrapper
...
1. READ matrices/ui/atoms/IconSymbol.md for complete style properties
