================================================================================
TASK: UI-097 - RouteLegTimeline (Ios)
================================================================================
...
Implement RouteLegTimeline component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RouteLegTimeline.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: RouteLegTimelineTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/RouteLegTimeline.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/RouteLegTimelineTests.swift (NEW)
