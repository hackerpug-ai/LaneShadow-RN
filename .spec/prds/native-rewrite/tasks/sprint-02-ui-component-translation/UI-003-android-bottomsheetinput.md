================================================================================
TASK: UI-003 - BottomSheetInput (Android)
================================================================================
...
Implement BottomSheetInput component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/BottomSheetInput.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/BottomSheetInputTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  TEST_FILE: BottomSheetInputTest.kt
  TEST_FUNCTION: testBottomSheetInputDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: BottomSheetInputTest.kt
  TEST_FUNCTION: testBottomSheetInputStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: BottomSheetInputTest.kt
  TEST_FUNCTION: testBottomSheetInputStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/atoms/BottomSheetInput.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/bottomsheetinput.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/BottomSheetInput.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/BottomSheetInputTest.kt (NEW)
...
**Current state:** BottomSheetInput exists as React Native wrapper
...
1. READ matrices/ui/atoms/BottomSheetInput.md for complete style properties
