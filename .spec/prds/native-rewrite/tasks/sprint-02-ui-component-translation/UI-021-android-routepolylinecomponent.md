================================================================================
TASK: UI-021 - RoutePolylineComponent (Android)
================================================================================
...
Implement RoutePolylineComponent component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RoutePolylineComponent.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RoutePolylineComponentTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: RoutePolylineComponent is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RoutePolylineComponentTest.kt
  TEST_FUNCTION: testRoutePolylineComponentDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RoutePolylineComponentTest.kt
  TEST_FUNCTION: testRoutePolylineComponentStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RoutePolylineComponentTest.kt
  TEST_FUNCTION: testRoutePolylineComponentStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/atoms/RoutePolylineComponent.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/routepolylinecomponent.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/RoutePolylineComponent.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RoutePolylineComponentTest.kt (NEW)
...
**Current state:** RoutePolylineComponent exists as React Native wrapper
...
1. READ matrices/ui/atoms/RoutePolylineComponent.md for complete style properties
