================================================================================
TASK: UI-074 - MinimalOverlayWidgetPreview (Ios)
================================================================================
...
Implement MinimalOverlayWidgetPreview component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/MinimalOverlayWidgetPreview.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: MinimalOverlayWidgetPreviewTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/MinimalOverlayWidgetPreview.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/MinimalOverlayWidgetPreviewTests.swift (NEW)
