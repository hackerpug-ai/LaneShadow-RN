================================================================================
TASK: UI-175 - GatekeeperUpgradePrompt (Ios)
================================================================================
...
Implement GatekeeperUpgradePrompt component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/GatekeeperUpgradePrompt.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: GatekeeperUpgradePromptTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/GatekeeperUpgradePrompt.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/GatekeeperUpgradePromptTests.swift (NEW)
...
// SwiftUI pattern
struct GatekeeperUpgradePrompt: View {
