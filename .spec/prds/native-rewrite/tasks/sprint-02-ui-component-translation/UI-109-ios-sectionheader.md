...
Implement SectionHeader component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/SectionHeader.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: SectionHeaderTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/SectionHeader.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/SectionHeaderTests.swift (NEW)
