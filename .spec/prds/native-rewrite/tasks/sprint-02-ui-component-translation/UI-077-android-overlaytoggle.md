================================================================================
TASK: UI-077 - OverlayToggle (Android)
================================================================================
...
Implement OverlayToggle component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/OverlayToggle.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/OverlayToggleTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: OverlayToggle is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: OverlayToggleTest.kt
  TEST_FUNCTION: testOverlayToggleDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: OverlayToggleTest.kt
  TEST_FUNCTION: testOverlayToggleStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: OverlayToggleTest.kt
  TEST_FUNCTION: testOverlayToggleStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/OverlayToggle.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/overlaytoggle.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/OverlayToggle.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/OverlayToggleTest.kt (NEW)
...
**Current state:** OverlayToggle exists as React Native wrapper
...
1. READ matrices/ui/molecules/OverlayToggle.md for complete style properties
