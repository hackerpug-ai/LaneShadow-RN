================================================================================
TASK: UI-176 - MenuLayout (Android)
================================================================================
...
Implement MenuLayout component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/MenuLayout.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/MenuLayoutTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: MenuLayout is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MenuLayoutTest.kt
  TEST_FUNCTION: testMenuLayoutDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MenuLayoutTest.kt
  TEST_FUNCTION: testMenuLayoutStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: MenuLayoutTest.kt
  TEST_FUNCTION: testMenuLayoutStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/screens/MenuLayout.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/menulayout.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/MenuLayout.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/MenuLayoutTest.kt (NEW)
...
**Current state:** MenuLayout exists as React Native wrapper
...
1. READ matrices/ui/screens/MenuLayout.md for complete style properties
