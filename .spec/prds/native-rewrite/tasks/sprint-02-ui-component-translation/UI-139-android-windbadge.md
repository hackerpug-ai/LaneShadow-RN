...
Implement WindBadge component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/WindBadge.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/WindBadgeTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: WindBadge is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WindBadgeTest.kt
  TEST_FUNCTION: testWindBadgeDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WindBadgeTest.kt
  TEST_FUNCTION: testWindBadgeStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: WindBadgeTest.kt
  TEST_FUNCTION: testWindBadgeStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/WindBadge.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/windbadge.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/WindBadge.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/WindBadgeTest.kt (NEW)
...
**Current state:** WindBadge exists as React Native wrapper
...
1. READ matrices/ui/molecules/WindBadge.md for complete style properties
