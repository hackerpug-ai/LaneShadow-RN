================================================================================
TASK: UI-094 - RenameRouteDialog (Android)
================================================================================
...
Implement RenameRouteDialog component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RenameRouteDialog.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RenameRouteDialogTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: RenameRouteDialog is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RenameRouteDialogTest.kt
  TEST_FUNCTION: testRenameRouteDialogDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RenameRouteDialogTest.kt
  TEST_FUNCTION: testRenameRouteDialogStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: RenameRouteDialogTest.kt
  TEST_FUNCTION: testRenameRouteDialogStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/RenameRouteDialog.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/renameroutedialog.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/RenameRouteDialog.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/RenameRouteDialogTest.kt (NEW)
...
**Current state:** RenameRouteDialog exists as React Native wrapper
...
1. READ matrices/ui/molecules/RenameRouteDialog.md for complete style properties
