================================================================================
TASK: UI-036 - CardSkeleton (Android)
================================================================================
...
Implement CardSkeleton component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/CardSkeleton.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/CardSkeletonTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: CardSkeleton is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: CardSkeletonTest.kt
  TEST_FUNCTION: testCardSkeletonDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: CardSkeletonTest.kt
  TEST_FUNCTION: testCardSkeletonStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: CardSkeletonTest.kt
  TEST_FUNCTION: testCardSkeletonStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/CardSkeleton.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/cardskeleton.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/CardSkeleton.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/CardSkeletonTest.kt (NEW)
...
**Current state:** CardSkeleton exists as React Native wrapper
...
1. READ matrices/ui/molecules/CardSkeleton.md for complete style properties
