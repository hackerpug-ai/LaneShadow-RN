================================================================================
TASK: UI-063 - IntentSearchSheet (Ios)
================================================================================
...
Implement IntentSearchSheet component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/IntentSearchSheet.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: IntentSearchSheetTests.swift
...
1. matrices/ui/molecules/IntentSearchSheet.md
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/IntentSearchSheet.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/IntentSearchSheetTests.swift (NEW)
...
1. READ matrices/ui/molecules/IntentSearchSheet.md for complete style properties
