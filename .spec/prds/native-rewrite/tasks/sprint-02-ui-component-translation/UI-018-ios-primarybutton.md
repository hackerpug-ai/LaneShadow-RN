...
Implement PrimaryButton component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/PrimaryButton.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: PrimaryButtonTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/PrimaryButton.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/PrimaryButtonTests.swift (NEW)
