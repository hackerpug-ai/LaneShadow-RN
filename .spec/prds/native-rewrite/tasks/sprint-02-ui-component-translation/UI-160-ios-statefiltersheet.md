================================================================================
TASK: UI-160 - StateFilterSheet (Ios)
================================================================================
...
Implement StateFilterSheet component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/StateFilterSheet.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: StateFilterSheetTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/StateFilterSheet.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/StateFilterSheetTests.swift (NEW)
