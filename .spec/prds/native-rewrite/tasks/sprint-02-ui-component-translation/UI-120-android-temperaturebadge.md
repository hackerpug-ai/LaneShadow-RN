================================================================================
TASK: UI-120 - TemperatureBadge (Android)
================================================================================
...
Implement TemperatureBadge component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/TemperatureBadge.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/TemperatureBadgeTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: TemperatureBadge is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: TemperatureBadgeTest.kt
  TEST_FUNCTION: testTemperatureBadgeDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: TemperatureBadgeTest.kt
  TEST_FUNCTION: testTemperatureBadgeStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: TemperatureBadgeTest.kt
  TEST_FUNCTION: testTemperatureBadgeStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/TemperatureBadge.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/temperaturebadge.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/TemperatureBadge.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/TemperatureBadgeTest.kt (NEW)
...
**Current state:** TemperatureBadge exists as React Native wrapper
...
1. READ matrices/ui/molecules/TemperatureBadge.md for complete style properties
