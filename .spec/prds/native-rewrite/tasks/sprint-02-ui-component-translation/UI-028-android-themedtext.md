================================================================================
TASK: UI-028 - ThemedText (Android)
================================================================================
...
Implement ThemedText component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/ThemedText.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/ThemedTextTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: ThemedText is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ThemedTextTest.kt
  TEST_FUNCTION: testThemedTextDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ThemedTextTest.kt
  TEST_FUNCTION: testThemedTextStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: ThemedTextTest.kt
  TEST_FUNCTION: testThemedTextStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/atoms/ThemedText.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/themedtext.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/ThemedText.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/ThemedTextTest.kt (NEW)
...
**Current state:** ThemedText exists as React Native wrapper
...
1. READ matrices/ui/atoms/ThemedText.md for complete style properties
