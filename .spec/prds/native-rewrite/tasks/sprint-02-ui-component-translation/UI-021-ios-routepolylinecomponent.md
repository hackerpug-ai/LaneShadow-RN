================================================================================
TASK: UI-021 - RoutePolylineComponent (Ios)
================================================================================
...
Implement RoutePolylineComponent component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RoutePolylineComponent.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: RoutePolylineComponentTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/RoutePolylineComponent.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/RoutePolylineComponentTests.swift (NEW)
...
// SwiftUI pattern
struct RoutePolylineComponent: View {
