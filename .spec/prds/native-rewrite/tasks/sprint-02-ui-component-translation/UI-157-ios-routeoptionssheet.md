================================================================================
TASK: UI-157 - RouteOptionsSheet (Ios)
================================================================================
...
Implement RouteOptionsSheet component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/RouteOptionsSheet.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: RouteOptionsSheetTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/RouteOptionsSheet.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/RouteOptionsSheetTests.swift (NEW)
