...
Implement EmptyState component in SwiftUI following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/EmptyState.kt (NEW): SwiftUI implementation
...
AC-1: Component renders in default state
  ...
  TEST_FILE: EmptyStateTests.swift
...
WRITE-ALLOWED:
- react-native/ios/LaneShadow/Components/UI/EmptyState.swift (NEW)
- react-native/ios/LaneShadowTests/Components/UI/EmptyStateTests.swift (NEW)
