================================================================================
TASK: UI-110 - SegmentDetailView (Android)
================================================================================
...
Implement SegmentDetailView component in Jetpack Compose following the translation matrix specification.

--------------------------------------------------------------------------------
DELIVERABLE
--------------------------------------------------------------------------------

- react-native/android/app/src/main/java/com/laneshadow/components/ui/SegmentDetailView.kt (NEW): Jetpack Compose implementation
- react-native/android/app/src/test/java/com/laneshadow/components/ui/SegmentDetailViewTest.kt (NEW): Component tests
...
AC-1: Component renders in default state
  ...
  WHEN: SegmentDetailView is rendered with required props
  THEN: Component displays matching RN wrapper defaults

  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: SegmentDetailViewTest.kt
  TEST_FUNCTION: testSegmentDetailViewDefaultRendering
...
AC-2: All style properties match matrix
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: SegmentDetailViewTest.kt
  TEST_FUNCTION: testSegmentDetailViewStylePropertiesMatchMatrix
...
AC-3: Component handles all states
  ...
  TDD_STATE: [ ] RED  [ ] VERIFY_RED  [ ] GREEN  [ ] VERIFY_GREEN  [ ] REFACTOR
  TEST_FILE: SegmentDetailViewTest.kt
  TEST_FUNCTION: testSegmentDetailViewStates

--------------------------------------------------------------------------------
READING LIST
--------------------------------------------------------------------------------

1. matrices/ui/molecules/SegmentDetailView.md
   - Lines: ALL
   - Focus: TRANSLATION SOURCES and STYLE PROPERTIES MATRIX

2. react-native/components/ui/segmentdetailview.tsx
   - Lines: ALL
...
WRITE-ALLOWED:
- react-native/android/app/src/main/java/com/laneshadow/components/ui/SegmentDetailView.kt (NEW)
- react-native/android/app/src/test/java/com/laneshadow/components/ui/SegmentDetailViewTest.kt (NEW)
...
**Current state:** SegmentDetailView exists as React Native wrapper
...
1. READ matrices/ui/molecules/SegmentDetailView.md for complete style properties
