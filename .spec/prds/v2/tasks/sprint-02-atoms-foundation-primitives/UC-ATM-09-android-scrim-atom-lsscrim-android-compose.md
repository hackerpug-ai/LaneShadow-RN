...
Gate 2: One test per behavioral AC; AC-2/AC-5/AC-6/AC-7 = grep/build gates.
...
Must pass (≤5):
- One test per behavioral AC; instrumented tests verify token color and pointer behavior.
