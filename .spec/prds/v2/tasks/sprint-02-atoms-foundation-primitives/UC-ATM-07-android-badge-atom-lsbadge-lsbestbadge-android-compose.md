...
Gate 2: One test per behavioral AC; AC-7..AC-10 = grep/build gates.
...
Must pass (≤5):
- One test per behavioral AC; instrumented tests verify token-resolved colors and leading icon names.
