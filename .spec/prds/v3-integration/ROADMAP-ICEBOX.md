...
archived: 2026-05-04T18:00:00-07:00
status: ICEBOX
prd: .spec/prds/v3-integration/README.md
sprint_count: 7
---

# 🧊 ICEBOX — Prior Sprint Roadmap (V3, pre-reshape)

> **This is the previous ROADMAP state, archived on 2026-05-04 when sprints 6+ were reshaped to ship one map view at a time.**
>
> The active roadmap is at [`ROADMAP.md`](./ROADMAP.md). This file preserves the prior bundled structure of:
> - **Sprint 06** — Saved Routes, Sessions & Settings (10 tasks across 4 surfaces)
> - **Sprint 07** — Map, Offline, Error Recovery & Ship Gate (10 tasks across 5 surfaces)
>
> User direction (2026-05-04): *"each sprint is super overscoped, we need to slow down and take each map view one at a time."*
>
> The original Sprint 6+ task expansions, design notes, dependencies, and PRD coverage entries below remain authoritative reference for any future re-pickup of the deferred surfaces (saved-routes browsing, settings, offline regions, error recovery, ship-gate hardening). Do not edit this file — re-promote items by drafting new sprints in the active ROADMAP.

---

# Sprint Roadmap: LaneShadow Native Integration (V3) — ARCHIVED
