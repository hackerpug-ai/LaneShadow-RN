...
**Status:** Remediation (red-hat review 2026-04-28 — R01..R04)
...
## Remediation Tasks (Red-Hat Review 2026-04-28)

| ID | Title | Agent | Estimate |
|----|-------|-------|----------|
| FID-S02-R01 | Motion token gap — add missing 1400ms recipe keys to motion.tokens.json + update both platforms | convex-implementer + swift-implementer + kotlin-implementer | 120 min |
| FID-S02-R02 | iOS test quality — replace empty stubs with real tests + create missing RouteResultsDetailsVariantTests.swift | swift-implementer | 180 min |
| FID-S02-R03 | Android missing molecules — create LSCancelConfirmSheet + LSSavedPill | kotlin-implementer | 90 min |
| FID-S02-R04 | Snapshot re-capture after R01–R03 fixes | swift-implementer + kotlin-implementer | 60 min |

**Remediation dependency chain:** R01 + R03 (parallel) → R02 → R04
...
| Task | File | Agent | ACs |
|------|------|-------|-----|
| FID-S02-R01 | [FID-S02-R01-motion-token-gap.md](./FID-S02-R01-motion-token-gap.md) | convex-implementer + platform implementers | 6 |
| FID-S02-R02 | [FID-S02-R02-ios-test-quality.md](./FID-S02-R02-ios-test-quality.md) | swift-implementer | 7 |
| FID-S02-R03 | [FID-S02-R03-android-missing-molecules.md](./FID-S02-R03-android-missing-molecules.md) | kotlin-implementer | 4 |
| FID-S02-R04 | [FID-S02-R04-snapshot-recapture.md](./FID-S02-R04-snapshot-recapture.md) | swift-implementer + kotlin-implementer | 4 |
