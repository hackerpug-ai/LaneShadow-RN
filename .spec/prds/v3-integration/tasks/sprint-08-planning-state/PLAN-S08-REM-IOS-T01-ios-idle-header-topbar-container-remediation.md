...
> Status: ✅ Completed
> Cycle: 4
> Commit: 66478b9f7a16bb16f52cf6f6e127ec3310d516ed
> Reviewer: swift-reviewer
> Review: .kb-run-sprint/tasks/PLAN-S08-REM-IOS-T01/review/4/response.json
> Updated: 2026-05-14T02:08:30Z
...
**Verify:** `cd ios && xcodebuild test -scheme LaneShadow -destination 'platform=iOS Simulator,name=iPhone 16' '-only-testing:LaneShadowTests/LSMapLayerTests/test_topbar_slot_fills_height_with_top_alignment()'`
...
**Verify:** `cd ios && xcodebuild test -scheme LaneShadow -destination 'platform=iOS Simulator,name=iPhone 16' '-only-testing:LaneShadowTests/LSTopBarTests/test_center_content_slot_keeps_menu_and_new_aligned()'`
...
**Verify:** `cd ios && xcodebuild test -scheme LaneShadow -destination 'platform=iOS Simulator,name=iPhone 16' '-only-testing:LaneShadowTests/IdleScreenRetrofitTests/test_live_idle_header_uses_single_topbar_container()' && xcodebuild test -scheme LaneShadow -destination 'platform=iOS Simulator,name=iPhone 16' -only-testing:LaneShadowUITests/DesignReviewCaptureTests/test_idleScreen_chatFocused_light`
...
**Verify:** `cd ios && xcodebuild test -scheme LaneShadow -destination 'platform=iOS Simulator,name=iPhone 16' '-only-testing:LaneShadowTests/IdleScreenTests/test_sandbox_idle_header_uses_single_topbar_container()'`
...
**Verify:** `scripts/tokens/enforce-native-compliance.sh && cd ios && xcodebuild build -scheme LaneShadow -destination 'platform=iOS Simulator,name=iPhone 16'`

## Test Criteria

| ID | Statement | Maps to AC | Verify | Type |
|---|---|---|---|---|
| TC-1 | LSMapLayer topBar slot fills height and aligns top when topBar is present | AC-1 | `cd ios && xcodebuild test -scheme LaneShadow -destination 'platform=iOS Simulator,name=iPhone 16' '-only-testing:LaneShadowTests/LSMapLayerTests/test_topbar_slot_fills_height_with_top_alignment()'` | happy_path |
| TC-2 | LSTopBar center content slot keeps menu leading and New trailing when custom center content is supplied | AC-2 | `cd ios && xcodebuild test -scheme LaneShadow -destination 'platform=iOS Simulator,name=iPhone 16' '-only-testing:LaneShadowTests/LSTopBarTests/test_center_content_slot_keeps_menu_and_new_aligned()'` | happy_path |
| TC-3 | IdleScreenContainer places the idle LSContextCapsule inside LSTopBar center content instead of topOverlays | AC-3 | `cd ios && xcodebuild test -scheme LaneShadow -destination 'platform=iOS Simulator,name=iPhone 16' '-only-testing:LaneShadowTests/IdleScreenRetrofitTests/test_live_idle_header_uses_single_topbar_container()' && xcodebuild test -scheme LaneShadow -destination 'platform=iOS Simulator,name=iPhone 16' -only-testing:LaneShadowUITests/DesignReviewCaptureTests/test_idleScreen_chatFocused_light` | edge |
| TC-4 | Sandbox IdleScreen uses the same single topbar header composition as live | AC-4 | `cd ios && xcodebuild test -scheme LaneShadow -destination 'platform=iOS Simulator,name=iPhone 16' '-only-testing:LaneShadowTests/IdleScreenTests/test_sandbox_idle_header_uses_single_topbar_container()'` | edge |
| TC-5 | Native token compliance and iOS build both exit 0 | AC-5 | `scripts/tokens/enforce-native-compliance.sh && cd ios && xcodebuild build -scheme LaneShadow -destination 'platform=iOS Simulator,name=iPhone 16'` | edge |
  ...
  "requirements": [
    {
      ...
      "verify": "cd ios && xcodebuild test -scheme LaneShadow -destination 'platform=iOS Simulator,name=iPhone 16' '-only-testing:LaneShadowTests/LSMapLayerTests/test_topbar_slot_fills_height_with_top_alignment()'",
      "satisfied": true,
      "evidence": "ios/LaneShadow/Views/Organisms/LSMapLayer.swift:92-95 keeps the topBar slot at full available height with `.frame(maxWidth: .infinity, maxHeight: .infinity, alignment: .top)`; focused selector passed in `.tmp/PLAN-S08-REM-IOS-T01-integration/lsmaplayer-test.log` (`LSMapLayerTests.test_topbar_slot_fills_height_with_top_alignment`).",
      "remediation": null,
      "last_evaluated_cycle": 4,
      "last_evaluated_commit": "9a36ad72aeb5c3bf5b718d68c46a535f0c231928",
      "maps_to_ac": null
    },
    {
      "id": "AC-2",
      ...
      "verify": "cd ios && xcodebuild test -scheme LaneShadow -destination 'platform=iOS Simulator,name=iPhone 16' '-only-testing:LaneShadowTests/LSTopBarTests/test_center_content_slot_keeps_menu_and_new_aligned()'",
      "satisfied": true,
      "evidence": "ios/LaneShadow/Views/Organisms/LSTopBar.swift:61-89 adds the centered-content initializer and renders menu/trailing chips in an HStack under a centered ZStack layer; focused selector passed in `.tmp/PLAN-S08-REM-IOS-T01-integration/lstopbar-test.log` (`LSTopBarTests.test_center_content_slot_keeps_menu_and_new_aligned`).",
      "remediation": null,
      "last_evaluated_cycle": 4,
      "last_evaluated_commit": "9a36ad72aeb5c3bf5b718d68c46a535f0c231928",
      "maps_to_ac": null
    },
    {
      ...
      "verify": "cd ios && xcodebuild test -scheme LaneShadow -destination 'platform=iOS Simulator,name=iPhone 16' '-only-testing:LaneShadowTests/IdleScreenRetrofitTests/test_live_idle_header_uses_single_topbar_container()' && xcodebuild test -scheme LaneShadow -destination 'platform=iOS Simulator,name=iPhone 16' -only-testing:LaneShadowUITests/DesignReviewCaptureTests/test_idleScreen_chatFocused_light",
      "satisfied": true,
      "evidence": "ios/LaneShadow/Features/Idle/IdleScreenContainer.swift:33-49 removes legacy `topOverlays` usage and injects `LSContextCapsule` via `LSTopBar(centerContent:)`; `capsuleView` is defined at lines 153-165. Focused selector passed in `.tmp/PLAN-S08-REM-IOS-T01-integration/idle-retrofit-header-test.log` (`IdleScreenRetrofitTests.test_live_idle_header_uses_single_topbar_container`).",
      "remediation": null,
      "last_evaluated_cycle": 4,
      "last_evaluated_commit": "9a36ad72aeb5c3bf5b718d68c46a535f0c231928",
      "maps_to_ac": null
    },
    {
      ...
      "verify": "cd ios && xcodebuild test -scheme LaneShadow -destination 'platform=iOS Simulator,name=iPhone 16' '-only-testing:LaneShadowTests/IdleScreenTests/test_sandbox_idle_header_uses_single_topbar_container()'",
      "satisfied": true,
      "evidence": "ios/LaneShadow/Views/Templates/IdleScreen.swift:67-80 uses the same single `LSTopBar(centerContent:)` composition, with `capsuleView` at lines 121-133 and `topOverlays: []`. Focused selector passed in `.tmp/PLAN-S08-REM-IOS-T01-integration/idle-template-header-test.log` (`IdleScreenTests.test_sandbox_idle_header_uses_single_topbar_container`).",
      "remediation": null,
      "last_evaluated_cycle": 4,
      "last_evaluated_commit": "9a36ad72aeb5c3bf5b718d68c46a535f0c231928",
      "maps_to_ac": null
    },
    {
      ...
      "verify": "scripts/tokens/enforce-native-compliance.sh && cd ios && xcodebuild build -scheme LaneShadow -destination 'platform=iOS Simulator,name=iPhone 16'",
      "satisfied": true,
      "evidence": "`scripts/tokens/enforce-native-compliance.sh` re-run exited 0. `.tmp/PLAN-S08-REM-IOS-T01-integration/ios-build.log` ends with `** BUILD SUCCEEDED **` for `xcodebuild build -scheme LaneShadow -destination 'platform=iOS Simulator,name=iPhone 16'`.",
      "remediation": null,
      "last_evaluated_cycle": 4,
      "last_evaluated_commit": "9a36ad72aeb5c3bf5b718d68c46a535f0c231928",
      "maps_to_ac": null
