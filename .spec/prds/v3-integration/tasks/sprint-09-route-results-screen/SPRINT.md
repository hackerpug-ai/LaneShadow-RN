...
| RR-S09-IOS-T05, AND-T05 | `.spec/design/system/refs/route-results-screen/*.png` (canonical reference set) + `LaneShadowUITests/DesignReview/DesignReviewCaptureTests.swift` (extended per task) + `templates.map-app.route-results-*` sandbox story IDs |
