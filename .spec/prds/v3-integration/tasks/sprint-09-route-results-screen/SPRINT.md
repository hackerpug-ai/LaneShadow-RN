...
| RR-S09-CVX-T01 | `.spec/prds/v3-integration/05-uc-chat.md` (UC-CHAT-03 AC list) + `.spec/prds/v3-integration/architecture/ios-architecture.md` §5.3 RouteResultsScreen — read as historical context for state.routes shape, target `MapAppState.routeResults` going forward + `convex/db/routePlans.ts` (getPlanByIdHandler) |
