...
|------|------------------|
| RR-S09-DR-T01 | `.spec/design/system/views/route-results-screen/README.md` (canonical 7-variant matrix) + `.spec/design/system/views/route-results-screen/*/*.png` (current reference assets) + `scripts/design-review/prompts/visual-eval.md` |
...
| RR-S09-IOS-T01, T02, AND-T01, AND-T02 | `.spec/design/system/views/route-results-screen/route-results-screen.html` + `.spec/design/system/views/route-results-screen/README.md` + `.spec/design/system/molecules/context-capsule/README.md` + `.spec/design/system/molecules/route-attachment-card/README.md` (or equivalent path) + `ios/LaneShadow/Views/Templates/MapApp.swift` + `ios/LaneShadow/Features/MapApp/MapAppState.swift` + `ios/LaneShadow/Features/MapApp/MapAppViewModel.swift` |
...
| RR-S09-IOS-T05, AND-T05 | `.spec/design/system/views/route-results-screen/*/*.png` (canonical reference set) + `LaneShadowUITests/DesignReview/DesignReviewCaptureTests.swift` (extended per task) + `templates.map-app.route-results-*` sandbox story IDs |
