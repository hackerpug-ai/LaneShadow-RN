...
**References:**
- `.spec/design/system/views/mapapp/route-results/route-results.html` (visual contract — polyline strokes, card composition)
- `.spec/design/system/views/mapapp/route-results/README.md` (variant matrix)
- `.spec/design/system/views/mapapp/route-results/default--best-pre-selected/default--best-pre-selected.light.png` (S01 reference)
