...
**Status:** In Progress — remediation round-3 wave-5 (2026-05-03: 11/18 tasks Done, 7 reopened (R02/R06/R08/R09/R11/R12/R14), 1 new (R18), 8 human gate steps still unverifiable)
...
| CHAT-S04-R02 | Convex `db.savedRoutes.getRouteIndexFingerprint` query + composite index (F-08) | convex-implementer | 90 min | — | R08, R12 | **REOPENED (RF-22)** |
...
| CHAT-S04-R06 | iOS phase name alignment (F-06) | swift-implementer | 60 min | — | R08 | **REOPENED (RF-20)** |
| CHAT-S04-R07 | iOS sandbox story ID normalization (F-16) | swift-implementer | 60 min | — | R10 | Backlog |
| CHAT-S04-R08 | iOS XCUITest E2E suite — 8 gate steps | swift-implementer | 360 min | R01, R02, R05, R06, R16 | — | **REOPENED (RF-19, RF-21)** |
| CHAT-S04-R09 | Android `RouteResultsScreen` tap + recall + alt polyline (F-18) | kotlin-implementer | 180 min | — | R12 | **REOPENED round-3 (RF-21)** |
| CHAT-S04-R10 | Android `AppStories` registration (F-15) | kotlin-implementer | 90 min | R07 | R12 | Backlog |
| CHAT-S04-R11 | Android phase name alignment (F-06) | kotlin-implementer | 60 min | — | R12 | **REOPENED (RF-20)** |
| CHAT-S04-R12 | Android instrumented E2E suite — 8 gate steps | kotlin-implementer | 360 min | R01, R02, R03, R09, R10, R11 | — | **REOPENED (RF-19, RF-21, RF-24)** |
| CHAT-S04-R13 | iOS `LaneShadowErrorMapping` + FORBIDDEN case | swift-implementer | 30 min | R17 | — | Backlog |
| CHAT-S04-R14 | Android `LaneShadowErrorMapper` + FORBIDDEN case | kotlin-implementer | 30 min | R17 | — | **REOPENED (RF-23)** |
| CHAT-S04-R15 | Convex `completeEnrichment` no-op fix (F-13) | convex-implementer | 30 min | — | — | **Done** |
| CHAT-S04-R16 | iOS R05 RouteDetailsScreenViewStateTests crash fix (RF-06) | swift-implementer | 60 min | — | R08 | **Done** |
| CHAT-S04-R17 | Convex auth-error-taxonomy.json fixture emission (R03 AC-7, RF-07) | convex-implementer | 30 min | R03 | R13, R14 | **Done** |
| CHAT-S04-R18 | Convex return validators for getPlanById + sessionMessages.list (RF-29) | convex-implementer | 30 min | — | — | **NEW (round-3)** |
...
- [CHAT-S04-R02-convex-saved-routes-fingerprint.md](CHAT-S04-R02-convex-saved-routes-fingerprint.md) (convex-implementer, 90 min) — **REOPENED (RF-22: composite index architecturally broken)**
...
- [CHAT-S04-R06-ios-phase-name-alignment.md](CHAT-S04-R06-ios-phase-name-alignment.md) (swift-implementer, 60 min) — **REOPENED (RF-20: Phase enum not wired into live data path)**
- [CHAT-S04-R07-ios-story-id-normalization.md](CHAT-S04-R07-ios-story-id-normalization.md) (swift-implementer, 60 min) — **Done**
- [CHAT-S04-R08-ios-e2e-xcuitest-baseline.md](CHAT-S04-R08-ios-e2e-xcuitest-baseline.md) (swift-implementer, 360 min) — **REOPENED (RF-19: fake JWT auth; RF-21: weak assertions)**
- [CHAT-S04-R09-android-route-results-tap-recall.md](CHAT-S04-R09-android-route-results-tap-recall.md) (kotlin-implementer, 180 min) — **REOPENED round-3 (RF-21: existence assertions not semantics)**
- [CHAT-S04-R10-android-app-stories-sprint04.md](CHAT-S04-R10-android-app-stories-sprint04.md) (kotlin-implementer, 90 min) — **Done**
- [CHAT-S04-R11-android-phase-name-alignment.md](CHAT-S04-R11-android-phase-name-alignment.md) (kotlin-implementer, 60 min) — **REOPENED (RF-20: Phase enum dead code)**
- [CHAT-S04-R12-android-e2e-instrumented-baseline.md](CHAT-S04-R12-android-e2e-instrumented-baseline.md) (kotlin-implementer, 360 min) — **REOPENED (RF-19: stubbed ConvexClient; RF-24: 4 helper files missing)**
- [CHAT-S04-R13-ios-mapper-align-auth-taxonomy.md](CHAT-S04-R13-ios-mapper-align-auth-taxonomy.md) (swift-implementer, 30 min) — **Done**
- [CHAT-S04-R14-android-mapper-align-auth-taxonomy.md](CHAT-S04-R14-android-mapper-align-auth-taxonomy.md) (kotlin-implementer, 30 min) — **REOPENED (RF-23: NETWORK_TIMEOUT fixture round-trip fails)**
- [CHAT-S04-R15-convex-completeEnrichment-noop-fix.md](CHAT-S04-R15-convex-completeEnrichment-noop-fix.md) (convex-implementer, 30 min) — **Done**
- [CHAT-S04-R16-ios-r05-test-crash-fix.md](CHAT-S04-R16-ios-r05-test-crash-fix.md) (swift-implementer, 60 min) — **Done**
- [CHAT-S04-R17-convex-auth-fixture-emission.md](CHAT-S04-R17-convex-auth-fixture-emission.md) (convex-implementer, 30 min) — **Done**
- [CHAT-S04-R18-convex-return-validators.md](CHAT-S04-R18-convex-return-validators.md) (convex-implementer, 30 min) — **NEW (round-3 RF-29)**

**Updated wave plan for `/kb-run-sprint --limit 2` (wave-5 round-3 remediation):**
- Wave 0 (parallel-2): R14 (remove NETWORK_TIMEOUT from fixture), R18 (v.any() validators)
- Wave 1 (parallel-2): R02 (composite index fix), R06 ‖ R11 (wire Phase enum through live data path)
- Wave 2 (parallel-2): R09 (semantics assertions), R08 (real Clerk auth + strong assertions)
- Wave 3 (parallel-2): R12 (missing helpers + real ConvexClient), R08 continued if needed
- Wave 4 (sequential): R08 + R12 final verification → re-run `/review-red-hat`

**Sprint-04 closure gate:** All 18 remediation tasks Done + R08 (iOS) + R12 (Android) E2E suites green on real Convex backend with real Clerk auth → re-run `/review-red-hat` to confirm all findings closed → human walks the 8-step gate on real iPhone with R08 evidence artifacts attached.
