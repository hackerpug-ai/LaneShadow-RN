# IDLE-S06-REM-AND-T02 — Android idle input place autocomplete
...
When an Android rider types in the Sprint 06 idle input, Compose shows up to three Mapbox-backed place recommendations and selection primes the input without routing.
...
- [ ] AC-3: Compose renders at most three accessible place recommendation rows
- [ ] AC-4: Selecting a recommendation retrieves the place, fills input, stores selected metadata, and leaves `navigateTo == null`
- [ ] AC-5: Stale autocomplete responses cannot overwrite newer query results
- [ ] AC-6: Autocomplete failures are recoverable without disabling the idle input
...
- `ios/**` - owned by IDLE-S06-REM-IOS-T02
...
- **Depends on:** IDLE-S06-REM-CVX-T02, IDLE-S06-REM-AND-T01
