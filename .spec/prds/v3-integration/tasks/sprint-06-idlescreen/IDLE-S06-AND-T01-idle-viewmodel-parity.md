...
- [ ] AC-3: `metaRow == "FRIDAY · 68°F · CLEAR"` from `WeatherSummary(68.4, 'Clear', FRIDAY)`
- [ ] AC-4: `WeatherSeverity.ADVISORY` sets `showAdvisoryCard = true`
- [ ] AC-5: Blank displayName → `firstName == 'Rider'`
- [ ] AC-6: FavoritesRepository emission of one item → `state.favoriteLocations.size == 1`
- [ ] All `./gradlew :app:testDebugUnitTest --tests 'com.laneshadow.ui.idle.IdleViewModelTest'` pass + detekt + native compliance
