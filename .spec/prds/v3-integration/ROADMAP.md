...
- **Sprint 09** delivers a production-grade **Map View · Route Results State** — three real polylines, real Navigator message, real route attachment cards, real refine + alt-select interactions, all as a NEW MapApp state (not a sibling screen) — that passes the design-review pipeline.
- **Sprint 10** delivers a production-grade **Map View · Route Details State (bottom-sheet overlay)** — real metrics, real weather timeline, real save / ride actions — composed as a sub-state overlay above `MapAppState.RouteResults` rather than a separate screen; passes the design-review pipeline.
- **Sprint 11** delivers a production-grade **Map View · Sessions Drawer (modal overlay of Idle)** — real session list, real grouping, real switch-with-camera-restore — composed as a leading-drawer modal over `MapAppState.Idle` rather than a separate screen; passes the design-review pipeline.
...
| AUTH-S03-T02 | Type-gen pipeline — `scripts/generate-mobile-types.ts` reads `_generated/api.d.ts` and emits `ios/LaneShadow/Generated/ConvexTypes.generated.swift` (Codable structs) + `android/app/src/main/.../generated/ConvexTypes.kt` (`@Serializable` data classes); wire into `pnpm server:codegen` | convex-implementer | 360 min |
...
- Native auth UI did not match `.spec/design/system/views/auth/auth-screen.html`.
...
|------|-----------------|
| FID-S05-T02 | [`.spec/design/system/views/auth/auth-screen.html`](../../../.spec/design/system/views/auth/auth-screen.html) (representative; references span all 7 views) |
...
| FID-S05-T05 | [`.spec/design/system/views/auth/README.md`](../../../.spec/design/system/views/auth/README.md) (Token Recipe table format used for all 7 views) |
...
**Design Reference:** [`.spec/design/system/views/mapapp/idle/README.md`](../../design/system/views/mapapp/idle/README.md) · [`idle-screen.html`](../../design/system/views/mapapp/idle/idle-screen.html) (updated 2026-05-06)
...
1. **Reference assets** — `.spec/design/system/views/mapapp/idle/` must contain PNGs + annotations for all 7 idle-screen variants (S01 default light, S02 typing/send, S03 default dark, S04 filter sheet, V01 no-location, V02 first-ride, V03 weather-advisory). Run `pnpm design:references` to generate.
...
**Design Reference:** Design-system update 2026-05-06 — [`mol-context-capsule`](../../design/system/molecules/context-capsule/context-capsule.html) (5 state variants) · [`org-map-controls`](../../design/system/organisms/map-controls/map-controls.html) · [`idle-screen.html`](../../design/system/views/mapapp/idle/idle-screen.html) (updated 2026-05-06)
...
**Design Reference:** [`.spec/design/system/views/mapapp/planning/README.md`](../../design/system/views/mapapp/planning/README.md) · [`planning-screen.html`](../../design/system/views/mapapp/planning/planning-screen.html)
...
1. **Reference assets** — `.spec/design/system/views/mapapp/planning/` must contain PNGs + annotations for all 7 planning-screen variants (S01 Scouting Light, S02 Drawing Light, S03 Weather Light, S04 Scoring Dark, V01 Slow Planning, V02 Cancel Prompt, V03 Single Candidate). Run `pnpm design:references` to generate.
...
- [`views/mapapp/planning/scouting/`](../../design/system/views/mapapp/planning/scouting/) — phase 1 active
- [`views/mapapp/planning/drawing/`](../../design/system/views/mapapp/planning/drawing/) — phase 2 active
- [`views/mapapp/planning/weather/`](../../design/system/views/mapapp/planning/weather/) — phase 3 active
- [`views/mapapp/planning/scoring/`](../../design/system/views/mapapp/planning/scoring/) — phase 4 active (light + dark)
- [`views/mapapp/planning/slow-planning/`](../../design/system/views/mapapp/planning/slow-planning/)
- [`views/mapapp/planning/single-candidate/`](../../design/system/views/mapapp/planning/single-candidate/)
- [`views/mapapp/planning/cancel-prompt/`](../../design/system/views/mapapp/planning/cancel-prompt/) — modal sheet overlay (sub-state of planning)

Implementation files: `ios/LaneShadow/Views/Templates/MapApp.swift` + `MapAppState.swift` + `MapAppViewModel.swift` (iOS); `android/app/src/main/java/com/laneshadow/ui/mapapp/MapApp.kt` + sealed `MapAppState.kt` + `MapAppViewModel.kt` (Android). MAPAPP-UNIFY iOS Cycle 2 (`be8fff154`) + Android Cycle 3 (`0f008ebd4`) shipped the persistent-host scaffolding; this sprint's tasks compose the planning overlays on top.

---

### Sprint 09: Map View · Route Results State

*(Previously titled "Sprint 09: RouteResultsScreen" — renamed 2026-05-15 to align with the One View, Many States doctrine. The work targets a `MapAppState.routeResults` state addition, not a sibling screen. Sprint folder is unchanged: `tasks/sprint-09-route-results-screen/`.)*
...
**Design Reference:** [`route-results-screen.html`](../../design/system/views/mapapp/route-results/route-results-screen.html) · [`README.md`](../../design/system/views/mapapp/route-results/README.md)
**View Map Reference:** [`VIEW-MAP.md` § 2 — `MapAppState.RouteResults`](./VIEW-MAP.md#2-target-ia-tree)

#### Human Testing Gate

**Gate:** From the planning state, `MapApp` transitions to a new route-results state — three live polylines (best/alt1/alt2) sourced from `db.routePlans.getPlanById`, pinned LSNavigatorMessage with three attached LSRouteAttachmentCard molecules, working alt-selection promotion, working chat-refine, working dismiss/recall — composed as state-derived overlays on the persistent `MapApp` host (no sibling screen, no NavigationStack push) and matching the `route-results-screen` design references via `pnpm design:review --screens route-results-screen` with **zero `high`-severity issues** across every reachable variant.
...
1. **Reference assets** — `.spec/design/system/views/mapapp/route-results/` must contain PNGs + annotations for all 7 route-results variants (S01 default light, S02 alt-selected, S03 dark, S04 refining-scrim, V01 fewer-than-3, V02 single-candidate, V03 recall-chip). Run `pnpm design:references` to generate.
...
- [`views/mapapp/route-results/default--best-pre-selected/`](../../design/system/views/mapapp/route-results/default--best-pre-selected/) (double-dash preserved from original design source)
- [`views/mapapp/route-results/default--dark/`](../../design/system/views/mapapp/route-results/default--dark/) (dark theme of default)
- [`views/mapapp/route-results/alt1-tapped--sage-promoted/`](../../design/system/views/mapapp/route-results/alt1-tapped--sage-promoted/)
- [`views/mapapp/route-results/two-candidates/`](../../design/system/views/mapapp/route-results/two-candidates/)
- [`views/mapapp/route-results/refining/`](../../design/system/views/mapapp/route-results/refining/)
- [`views/mapapp/route-results/weather-divergent/`](../../design/system/views/mapapp/route-results/weather-divergent/)
- [`views/mapapp/route-results/message-dismissed/`](../../design/system/views/mapapp/route-results/message-dismissed/)
...
- [RR-S09-DR-T01-reconcile-route-results-variant-naming.md](./tasks/sprint-09-route-results-screen/RR-S09-DR-T01-reconcile-route-results-variant-naming.md)
- [RR-S09-CVX-T01-convex-route-results-contract.md](./tasks/sprint-09-route-results-screen/RR-S09-CVX-T01-convex-route-results-contract.md)
- [RR-S09-IOS-T01-ios-route-results-view-model.md](./tasks/sprint-09-route-results-screen/RR-S09-IOS-T01-ios-route-results-view-model.md)
- [RR-S09-IOS-T02-ios-route-results-state-composition.md](./tasks/sprint-09-route-results-screen/RR-S09-IOS-T02-ios-route-results-state-composition.md)
- [RR-S09-IOS-T03-ios-three-polyline-rendering-and-alt-selection.md](./tasks/sprint-09-route-results-screen/RR-S09-IOS-T03-ios-three-polyline-rendering-and-alt-selection.md)
- [RR-S09-IOS-T04-ios-chat-refine-and-dismiss-recall.md](./tasks/sprint-09-route-results-screen/RR-S09-IOS-T04-ios-chat-refine-and-dismiss-recall.md)
- [RR-S09-IOS-T05-ios-design-review-capture-tests.md](./tasks/sprint-09-route-results-screen/RR-S09-IOS-T05-ios-design-review-capture-tests.md)
- [RR-S09-AND-T01-android-route-results-view-model.md](./tasks/sprint-09-route-results-screen/RR-S09-AND-T01-android-route-results-view-model.md)
- [RR-S09-AND-T02-android-route-results-state-composition.md](./tasks/sprint-09-route-results-screen/RR-S09-AND-T02-android-route-results-state-composition.md)
- [RR-S09-AND-T03-android-three-polyline-rendering-and-alt-selection.md](./tasks/sprint-09-route-results-screen/RR-S09-AND-T03-android-three-polyline-rendering-and-alt-selection.md)
- [RR-S09-AND-T04-android-chat-refine-and-dismiss-recall.md](./tasks/sprint-09-route-results-screen/RR-S09-AND-T04-android-chat-refine-and-dismiss-recall.md)
- [RR-S09-AND-T05-android-instrumented-design-review-capture.md](./tasks/sprint-09-route-results-screen/RR-S09-AND-T05-android-instrumented-design-review-capture.md)
- [RR-S09-E2E-IOS-T01-ios-route-results-live-e2e.md](./tasks/sprint-09-route-results-screen/RR-S09-E2E-IOS-T01-ios-route-results-live-e2e.md)
- [RR-S09-T11-sprint-gate.md](./tasks/sprint-09-route-results-screen/RR-S09-T11-sprint-gate.md)

---

### Sprint 10: Map View · Route Details State (bottom-sheet overlay)

*(Previously titled "Sprint 10: RouteDetails Bottom Sheet" — renamed 2026-05-15 to align with the One View, Many States doctrine. The work targets a sub-state composed as a bottom-sheet overlay above `MapAppState.routeResults`, not a sibling screen. Sprint folder will mirror Sprint 09's `route-details-screen` view-folder structure.)*

**Sequence:** 10
**Status:** Planned
**Design Reference:** [`.spec/design/system/views/mapapp/route-details/README.md`](../../design/system/views/mapapp/route-details/README.md) · [`route-details-screen.html`](../../design/system/views/mapapp/route-details/route-details-screen.html)
**View Map Reference:** [`VIEW-MAP.md` § 2 — `MapAppState.RouteDetails` (sub-state of RouteResults)](./VIEW-MAP.md#2-target-ia-tree)

#### Human Testing Gate

**Gate:** From the route-results state (Sprint 09), the rider can tap a route card and `MapApp` composes a route-details bottom-sheet overlay above the same map host — single polyline framed against paper canvas, LSRouteSheet at large detent with copper "BEST FOR TODAY" badge, Newsreader-serif title, real 4-column LSInstrumentReadout (DIST / TIME / CLIMB / SCENIC), real 6-cell LSWeatherTimeline from `db.routeEnrichments.list`, sticky outline `Save` + copper primary `Ride this` action row — composed as a sub-state overlay (no sibling screen, no NavigationStack push) and matching the `route-details-screen` design references via `pnpm design:review --screens route-details-screen` with **zero `high`-severity issues** across every reachable variant.
...
1. **Reference assets** — `.spec/design/system/views/mapapp/route-details/` must contain PNGs + annotations for all 6 route-details variants (S01 default large light, S02 mixed-weather, S03 dark, S04 medium detent, S05 dismissing, V01 saved-state). Run `pnpm design:references` to generate.
...
- [`views/mapapp/route-details/default/`](../../design/system/views/mapapp/route-details/default/) — light + dark
- [`views/mapapp/route-details/mixed-weather/`](../../design/system/views/mapapp/route-details/mixed-weather/)
- [`views/mapapp/route-details/saved-state/`](../../design/system/views/mapapp/route-details/saved-state/)
- [`views/mapapp/route-details/medium-detent/`](../../design/system/views/mapapp/route-details/medium-detent/)
- [`views/mapapp/route-details/dismissing/`](../../design/system/views/mapapp/route-details/dismissing/)

**Never a sibling `RouteDetailsScreen.swift`/`.kt` template.** Tap-from-card transitions are pure state mutations (`MapAppViewModel.goToRouteDetails(routePlanId:)`), not `NavigationLink` pushes. The bottom sheet is composed via `LSMapLayer.bottomOverlays` or an `.overlay { LSBottomSheet { ... } }` modifier on the persistent MapApp body.

---

### Sprint 11: Map View · Sessions Drawer (modal overlay of Idle)

*(Previously titled "Sprint 11: SessionsScreen" — renamed 2026-05-15 to align with the One View, Many States doctrine. The work targets a modal leading-drawer overlay above `MapAppState.idle`, not a sibling screen. Sprint folder will mirror the `sessions-screen` view-folder structure.)*

**Sequence:** 11
**Status:** Planned
**Design Reference:** [`sessions-screen.html`](../../design/system/views/mapapp/sessions-drawer/sessions-screen.html) · [`README.md`](../../design/system/views/mapapp/sessions-drawer/README.md)
**View Map Reference:** [`VIEW-MAP.md` § 2 — Sessions Drawer modal over `MapAppState.Idle`](./VIEW-MAP.md#2-target-ia-tree)

#### Human Testing Gate

**Gate:** From any `MapApp` state, the rider can tap the LSTopBar hamburger chip and `MapApp` slides open a leading-drawer modal listing sessions — left-anchored over a scrimmed paper map, active session marked with copper left-edge stripe + tinted row background, all sessions grouped by recency from `db.planningSessions.listSessions`, working tap-to-switch with camera restore, working `+ New session` — composed as `LSMapLayer.leadingDrawer` modal overlay over the persistent map host (no sibling screen, no NavigationStack push) and matching the `sessions-screen` design references via `pnpm design:review --screens sessions-screen` with **zero `high`-severity issues** across every reachable variant.
...
1. **Reference assets** — `.spec/design/system/views/mapapp/sessions-drawer/` must contain PNGs + annotations for all 5 sessions variants (S01 default light, S02 dark, S03 empty-state, S04 long-list scrolled, S05 new-confirm dialog). Run `pnpm design:references` to generate.
...
- [`views/mapapp/sessions-drawer/default/`](../../design/system/views/mapapp/sessions-drawer/default/) — light + dark
- [`views/mapapp/sessions-drawer/empty/`](../../design/system/views/mapapp/sessions-drawer/empty/)
- [`views/mapapp/sessions-drawer/scrolled/`](../../design/system/views/mapapp/sessions-drawer/scrolled/)
- [`views/mapapp/sessions-drawer/new-confirm/`](../../design/system/views/mapapp/sessions-drawer/new-confirm/)
