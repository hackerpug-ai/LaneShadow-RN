...
**Total Tasks:** 59
**Current Sprint:** Sprint 01 (In Progress — task expansion generated 2026-04-27)
...
| 2 | [Sprint 02: V2 Variants, Motion & Sandbox Coverage](#sprint-02-v2-variants-motion--sandbox-coverage) | All designed variants and motion recipes match HTML mockups; Android sandbox stories complete | 10 | Sprint 01 | Planned |
| 3 | [Sprint 03: Auth & Convex Foundation](#sprint-03-auth--convex-foundation) | Rider can sign in via OAuth on both platforms and see their real name on IdleScreen | 10 | Sprint 02 | Planned |
...
| FID-S02-T10 | Android organism stories implementation — register 27 stories: LSNavigatorMessage (6), LSInlineErrorCallout (5), LSRouteSheet (5), LSRouteCard (6), LSSectionHeader (5) — in AppStories.all; iOS view variant story coverage (Idle 1→7, RouteResults 1→7, Sessions 1→5, Error 1→6); record snapshot baselines on both platforms; verify `pnpm snapshots:check` + `pnpm snapshots:parity-report` clean | kotlin-implementer + swift-implementer | 360 min |
