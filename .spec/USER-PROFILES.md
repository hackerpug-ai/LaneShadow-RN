...
This document defines **who** we are building LaneShadow for. Every feature, interaction, and design decision should be evaluated against these profiles. If a feature doesn't serve one of these users, it's out of scope.
...
- Touring riders (Honda Gold Wing, BMW K1600, Harley Electra Glide, etc.)
- Recreational riders on any bike who prioritize the journey over the destination
...
| Metric | Value | Source |
|--------|-------|--------|
| U.S. registered on-road motorcycles | 8.8 million (2023) | IIHS |
| Median rider age | 50 years old | MIC 2018 |
| Median household income | $62,500 | MIC 2018 |
| Cruiser share of registrations | 38.2% | IIHS 2023 |
| Touring share of registrations | 23.5% | IIHS 2023 |
| Women as % of owners | 19% (growing to ~25%) | MIC 2018 |
| H-D average customer age | 45 | HDFS 2024 |
...
## Out of Scope: Who We Are NOT Building For
...
- MIC Owner Survey (2018) — Rider demographics, income, education
- HDFS Internal Data (2024) — Harley-Davidson customer age
- IBISWorld 2025 Report — Buying patterns by age group
- IIHS Registration Data (2023) — Bike type distribution by state
