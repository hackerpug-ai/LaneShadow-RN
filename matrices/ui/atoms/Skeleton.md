...
| duration | RN-wrapper | 1500ms (implied) | `infiniteRepeatable(tween(duration = 1500))` | `.animation(.easeInOut(duration: 1.5).repeatForever(autoreverses: true))` | ESCALATE — propose `motion.duration.pulse = 1500` |
