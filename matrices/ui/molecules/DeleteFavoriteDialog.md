# DeleteFavoriteDialog - STYLE PROPERTIES MATRIX

**Component:** DeleteFavoriteDialog
**RN Source:** `react-native/components/ui/delete-favorite-dialog.tsx`
...
|---|---|---|---|
| RN Wrapper | `react-native/components/ui/delete-favorite-dialog.tsx` | Public API, layout, confirmation dialog |
...
**Composition pattern:** Confirmation dialog with title, dynamic message (includes favorite name), and cancel/confirm actions.
...
| Property | Source | Value | Android equivalent | iOS equivalent | Token mapping |
|---|---|---|---|---|---|
| text | RN-wrapper | `'Delete saved route?'` | n/a | n/a | n/a |
...
| Property | Source | Value | Android equivalent | iOS equivalent | Token mapping |
|---|---|---|---|---|---|
| text | RN-wrapper | `` `Are you sure you want to delete "${favoriteName}"?` `` | n/a | n/a | n/a (dynamic) |
| color | RN-wrapper | `semantic.color.onSurface.default` | `LaneShadowTheme.colors.onSurface` | `theme.colors.onSurface` | `color.onSurface.default` |
...
- **Dynamic messaging:** Message includes favorite name via template literal
- **Text buttons:** Uses text mode buttons (not outlined/contained) for dialog actions per Material Design guidelines
- **Standard pattern:** Follows confirmation dialog pattern: clear question, specific item name, cancel/delete actions
