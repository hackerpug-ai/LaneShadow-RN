...
@inline(__always)
internal func dyn(_ light: Color, _ dark: Color) -> Color {
...
#else
@inline(__always)
internal func dyn(_ light: Color, _ dark: Color) -> Color { light }
#endif
...
private extension Theme {
    ...
    static func el(_ shadow: Color, _ ox: CGFloat, _ oy: CGFloat, _ op: CGFloat, _ rad: CGFloat, _ elv: CGFloat) -> ElevationStyle {
        ElevationStyle(
            shadowColor: shadow,
            offsetX: ox,
            offsetY: oy,
    ...
    static func buildElevation() -> ThemeElevation {
        ...
        return ThemeElevation(
            level0: el(E._0.shadowColor, E._0.ShadowOffset.width, E._0.ShadowOffset.height, E._0.shadowOpacity, E._0.shadowRadius, E._0.elevation),
            level1: el(E._1.shadowColor, E._1.ShadowOffset.width, E._1.ShadowOffset.height, E._1.shadowOpacity, E._1.shadowRadius, E._1.elevation),
            level2: el(E._2.shadowColor, E._2.ShadowOffset.width, E._2.ShadowOffset.height, E._2.shadowOpacity, E._2.shadowRadius, E._2.elevation),
            level3: el(E._3.shadowColor, E._3.ShadowOffset.width, E._3.ShadowOffset.height, E._3.shadowOpacity, E._3.shadowRadius, E._3.elevation),
            level4: el(E._4.shadowColor, E._4.ShadowOffset.width, E._4.ShadowOffset.height, E._4.shadowOpacity, E._4.shadowRadius, E._4.elevation),
            level5: el(E._5.shadowColor, E._5.ShadowOffset.width, E._5.ShadowOffset.height, E._5.shadowOpacity, E._5.shadowRadius, E._5.elevation)
        )
    }
}
