    ...
    public enum Semantic {
        public enum Color {
            public enum Light {
                ...
                public enum Surface {
                    ...
                    public static let disabled: SwiftUI.Color = .init(red: 1, green: 1, blue: 1, opacity: 1)
                }
                ...
                public enum OnSurface {
                    ...
                    public static let disabled: SwiftUI.Color = .init(
                        ...
                        green: 0.6392156862745098,
                        blue: 0.6862745098039216,
                        opacity: 1
                    )
                    public static let muted: SwiftUI.Color = .init(
                        red: 0.28627450980392155,
                        green: 0.27058823529411763,
                        blue: 0.30980392156862746,
                        opacity: 1
                    )
                    public static let subtle: SwiftUI.Color = .init(
                ...
                public enum OnSecondary {
                    public static let `default`: SwiftUI.Color = .init(red: 1, green: 1, blue: 1, opacity: 1)
                    public static let hover: SwiftUI.Color = .init(
                ...
                public enum Divider {
                    public static let `default`: SwiftUI.Color = .init(red: 0, green: 0, blue: 0, opacity: 0.08)
                }

                public enum Scrim {
                    public static let `default`: SwiftUI.Color = .init(red: 0, green: 0, blue: 0, opacity: 0.55)
                }
                ...
                public enum RouteAlternate {
                    public static let `default`: SwiftUI.Color = .init(red: 0, green: 0, blue: 0, opacity: 0.45)
                }
            ...
            public enum Dark {
                ...
                public enum OnSurface {
                    public static let `default`: SwiftUI.Color = .init(red: 1, green: 1, blue: 1, opacity: 0.92)
                    public static let hover: SwiftUI.Color = .init(red: 1, green: 1, blue: 1, opacity: 0.96)
                    public static let pressed: SwiftUI.Color = .init(red: 1, green: 1, blue: 1, opacity: 0.86)
                    public static let disabled: SwiftUI.Color = .init(
                        red: 0.4196078431372549,
                        green: 0.4470588235294118,
                        blue: 0.5019607843137255,
                    ...
                    public static let muted: SwiftUI.Color = .init(red: 1, green: 1, blue: 1, opacity: 0.72)
                    public static let subtle: SwiftUI.Color = .init(red: 1, green: 1, blue: 1, opacity: 0.55)
                }
                ...
                public enum OnSecondary {
                    ...
                    public static let hover: SwiftUI.Color = .init(red: 1, green: 1, blue: 1, opacity: 1)
                    public static let pressed: SwiftUI.Color = .init(
                        red: 0.8901960784313725,
                        green: 0.8901960784313725,
                ...
                public enum Border {
                    ...
                    public static let disabled: SwiftUI.Color = .init(red: 1, green: 1, blue: 1, opacity: 0.06)
                }
                ...
                public enum Divider {
                    public static let `default`: SwiftUI.Color = .init(red: 1, green: 1, blue: 1, opacity: 0.08)
                }
                ...
                public enum RouteAlternate {
                    public static let `default`: SwiftUI.Color = .init(red: 1, green: 1, blue: 1, opacity: 0.45)
                }
        ...
        public enum Elevation {
            public enum Light {
                ...
                public enum _1 {
                    public static let shadowColor: SwiftUI.Color = .init(red: 0, green: 0, blue: 0, opacity: 1)
                    public enum ShadowOffset {
                        public static let width: CGFloat = 0
