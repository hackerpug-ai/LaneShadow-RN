...
model: inherit
description: "When I need Android feature implementation, I hire this agent to write failing tests first, then build production Kotlin/Compose code from specs using TDD workflow (RED → GREEN → REFACTOR per AC) with Hilt, Room, and Material 3"
