/**
 * IconSymbol Component Story
 * Demonstrates MaterialCommunityIcons for Android and web
 */
...
const meta: Meta<typeof IconSymbol> = {
  title: 'Components/IconSymbol',
  component: IconSymbol,
  parameters: {
    docs: {
      description: {
        component: 'Icon component using MaterialCommunityIcons for Android and web. Works with all MaterialCommunityIcons glyph names.',
      },
    },
    layout: 'centered',
  },
