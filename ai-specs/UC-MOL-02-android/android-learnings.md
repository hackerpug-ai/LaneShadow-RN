...
2. `LaneShadowThemeValues` still does not expose `sizing.component.toolbarHeight`; using a direct `space.xxxxl` token bridge is more stable than reconstructing height from multiple spacing rungs.
