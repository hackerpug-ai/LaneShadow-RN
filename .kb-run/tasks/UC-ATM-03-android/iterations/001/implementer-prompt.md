...
Task ID: UC-ATM-03-android
Role: kotlin-implementer
Sprint: sprint-02-atoms-foundation-primitives
Worktree: /Users/justinrich/Projects/LaneShadow/.kb-run/worktrees/UC-ATM-03-android
Branch: kb-run/UC-ATM-03-android
...
- You may inspect existing repo patterns and, for UC-ATM-03-android, any task-specific prior evidence noted below.
...
- Recoverable evidence exists at commit 63df8b92. You may inspect or selectively replay it if useful, but do not bring back out-of-scope .spec learnings files and do not assume its scope/tests are sufficient.
- Repo-current drift: Android currently only has android/app/src/debug/java/com/laneshadow/sandbox/stories/AtomsStories.kt for atom aggregation. Align story registration with the current tree rather than stale task-doc path variants.
...

{
  "requirements": [
    {
      ...
      "summary": "LSTextField default state resolves border + radius + padding tokens [PRIMARY]"
    },
    {
      "id": "AC-2",
      "source": "ACCEPTANCE CRITERIA",
      "summary": "LSTextArea renders multi-line with starting row count"
    },
    {
      "id": "AC-3",
      "source": "ACCEPTANCE CRITERIA",
      "summary": "All four InputState values resolve correct border tokens"
    },
    {
      "id": "AC-4",
      "source": "ACCEPTANCE CRITERIA",
      "summary": "Focused state border distinct from default (interactive)"
    },
    {
      "id": "AC-5",
      "source": "ACCEPTANCE CRITERIA",
      "summary": "Error state applies color.border.danger"
    },
    {
      "id": "AC-6",
      "source": "ACCEPTANCE CRITERIA",
      "summary": "LSTextArea auto-grows up to maxRows, then scrolls"
    },
    {
      "id": "AC-7",
      "source": "ACCEPTANCE CRITERIA",
      "summary": "Stories registered (`atoms.textfield.{state}`, `atoms.textarea.{state}`) under src/debug"
    },
    {
      "id": "AC-8",
      "source": "ACCEPTANCE CRITERIA",
      "summary": "No literal color/font/icon refs in LSTextField/LSTextArea (boundary)"
    },
    {
      "id": "AC-9",
      "source": "ACCEPTANCE CRITERIA",
      "summary": "Release APK contains zero sandbox symbols (boundary gate)"
    },
    {
      "id": "TC-1",
      "source": "TEST CRITERIA",
      "summary": "LSTextField default resolves border/radius/padding tokens"
    },
    {
      "id": "TC-2",
      "source": "TEST CRITERIA",
      "summary": "LSTextArea renders multi-line"
    },
    {
      "id": "TC-3",
      "source": "TEST CRITERIA",
    ...
    },
    {
      "id": "TC-4",
      "source": "TEST CRITERIA",
      "summary": "Focused state applies border.focused"
    },
    {
      "id": "TC-5",
      "source": "TEST CRITERIA",
      "summary": "Error state applies border.danger"
    },
    {
      "id": "TC-6",
      "source": "TEST CRITERIA",
      "summary": "LSTextArea auto-grows then scrolls at maxRows"
    },
    {
      "id": "TC-7",
      "source": "TEST CRITERIA",
      "summary": "All input/textarea stories registered"
    },
    {
      "id": "TC-8",
      "source": "TEST CRITERIA",
      "summary": "LSTextField/LSTextArea contain zero literal color/font/icon refs"
    },
    {
      "id": "TC-9",
      "source": "TEST CRITERIA",
      "summary": "Release APK contains zero com.nativesandbox entries"
    }
  ],
  "supplemental_requirements": [
    {
      "id": "STATE-MATRIX",
      "source": "OUTCOME",
      "summary": "Outcome requires interaction-state coverage for default, disabled, focus, error; explicit AC/TC/DONE coverage is missing for disabled"
    }
  ],
  "outcome_states": [
    "default",
  ...
  "warnings": [
    "Outcome/AC drift detected: missing explicit state coverage for disabled"
  ]
}

## Required Evidence Outputs

- Write a concise evidence log to `/Users/justinrich/Projects/LaneShadow/.kb-run/tasks/UC-ATM-03-android/iterations/001/evidence.md`.
- Write an evidence manifest JSON to `/Users/justinrich/Projects/LaneShadow/.kb-run/tasks/UC-ATM-03-android/iterations/001/evidence-manifest.json` with:
  - `task_id`
  - `files_changed`
