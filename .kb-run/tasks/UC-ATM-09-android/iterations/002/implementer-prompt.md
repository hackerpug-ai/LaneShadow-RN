...
```json
{
  "task_file": "/Users/justinrich/Projects/LaneShadow/.spec/prds/v2/tasks/sprint-02-atoms-foundation-primitives/UC-ATM-09-android-scrim-atom-lsscrim-android-compose.md",
  "requirements": [
    {
      "id": "AC-1",
...
- Write a concise evidence log to `/Users/justinrich/Projects/LaneShadow/.kb-run/tasks/UC-ATM-09-android/iterations/002/evidence.md`.
- Write an evidence manifest JSON to `/Users/justinrich/Projects/LaneShadow/.kb-run/tasks/UC-ATM-09-android/iterations/002/evidence-manifest.json` with:
  - `task_id`
  - `files_changed`
