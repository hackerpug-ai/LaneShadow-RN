...
2. `RULES.md`
3. The role file for `kotlin-implementer` under `~/Projects/brain/agents/` if present.
...
```json
{
  "task_file": "/Users/justinrich/Projects/LaneShadow/.spec/prds/v2/tasks/sprint-02-atoms-foundation-primitives/UC-ATM-05-android-surface-trio-lscard-lspanel-lsglasspanel-android-compose.md",
  "requirements": [
    {
      "id": "AC-1",
...
- Write a concise evidence log to `/Users/justinrich/Projects/LaneShadow/.kb-run/tasks/UC-ATM-05-android/iterations/002/evidence.md`.
- Write an evidence manifest JSON to `/Users/justinrich/Projects/LaneShadow/.kb-run/tasks/UC-ATM-05-android/iterations/002/evidence-manifest.json` with:
  - `task_id`
  - `files_changed`
