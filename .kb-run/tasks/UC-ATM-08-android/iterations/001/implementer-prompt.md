...
- Check current theme/motion accessors in com.laneshadow.theme before assuming the exact task-doc symbol names exist.
...
- Write a concise evidence log to `/Users/justinrich/Projects/LaneShadow/.kb-run/tasks/UC-ATM-08-android/iterations/001/evidence.md`.
- Write an evidence manifest JSON to `/Users/justinrich/Projects/LaneShadow/.kb-run/tasks/UC-ATM-08-android/iterations/001/evidence-manifest.json` with:
  - `task_id`
  - `files_changed`
