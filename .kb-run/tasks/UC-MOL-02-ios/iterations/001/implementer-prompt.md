...
Implement `UC-MOL-02-ios` end-to-end per the task file using RED -> GREEN -> REFACTOR. Produce the molecule code, tests, story registration, any required project generation change, and a concise learnings note at `ai-specs/UC-MOL-02/ios-learnings.md` if you create or update learnings.

## Required Reading

1. `.spec/prds/v2/tasks/sprint-04-molecules-composite-patterns/UC-MOL-02-ios-toolbar-navheader-molecules.md`
2. `RULES.md`
