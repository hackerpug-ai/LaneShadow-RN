...
export function parseConvexApiTypes(
  apiPath = path.resolve(process.cwd(), 'convex/_generated/api.d.ts'),
  options: ParseConvexApiTypesOptions = {},
...
function generateSwiftSource(tables: Record<string, TableSchema>): string {
  ...
  return `// Generated by scripts/generate-mobile-types.ts. Do not edit.\nimport Foundation\n\n${structs}\n`
}
...
export function generateMobileTypes(rootDir = process.cwd()): GenerateMobileTypesResult {
  const parsedApi = parseConvexApiTypes(path.resolve(rootDir, 'convex/_generated/api.d.ts'), {
