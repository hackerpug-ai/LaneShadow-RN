...
class MapControlsTest {
    ...
    @Test
    fun testMapControlsRendersInMapMode() {
        ...
        composeTestRule.onNodeWithTag("map-controls").assertIsDisplayed()
        ...
        composeTestRule.onNodeWithContentDescription("Recenter map").assertIsDisplayed()
        composeTestRule.onNodeWithContentDescription("Reset map state").assertIsDisplayed()
        composeTestRule.onNodeWithContentDescription("Open chat").assertIsDisplayed()
    }

    @Test
    fun testMapControlsRendersInChatMode() {
        composeTestRule.setContent {
            CompositionLocalProvider(LocalLaneShadowTheme provides testTheme) {
                MapControls(
        ...
        composeTestRule.onNodeWithTag("map-controls").assertIsDisplayed()
        composeTestRule.onNodeWithContentDescription("Back to map").assertIsDisplayed()
    ...
    @Test
    fun testMapControlsShowsSaveRouteButtonWhenAvailable() {
        composeTestRule.setContent {
            CompositionLocalProvider(LocalLaneShadowTheme provides testTheme) {
                MapControls(
                    mode = MapControlsMode.MAP,
        ...
        composeTestRule.onNodeWithContentDescription("Save route").assertIsDisplayed()
    }

    @Test
    fun testMapControlsHidesSaveRouteButtonWhenNotAvailable() {
        composeTestRule.setContent {
            CompositionLocalProvider(LocalLaneShadowTheme provides testTheme) {
                MapControls(
                    mode = MapControlsMode.MAP,
    ...
    @Test
    fun testMapControlsShowsLabelsWhenEnabled() {
        composeTestRule.setContent {
            CompositionLocalProvider(LocalLaneShadowTheme provides testTheme) {
                MapControls(
                    mode = MapControlsMode.MAP,
    ...
    @Test
    fun testMapControlsHidesOptionalControlsWhenCallbacksNotProvided() {
        composeTestRule.setContent {
            CompositionLocalProvider(LocalLaneShadowTheme provides testTheme) {
                MapControls(
                    mode = MapControlsMode.MAP,
