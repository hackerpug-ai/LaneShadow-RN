...
/**
 * Shared test theme helper for component tests.
 *
 * Extracted from ErrorMessageTest.kt to eliminate ~140 lines of duplicate
 * theme construction across all atom and molecule test files.
 *
 * Usage:
 * ```kotlin
 ...
 * ```
 */
val testTheme = LaneShadowThemeValues(
