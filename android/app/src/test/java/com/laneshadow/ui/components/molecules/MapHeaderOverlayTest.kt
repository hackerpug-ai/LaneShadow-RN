...
class MapHeaderOverlayTest {
    ...
    @Test
    fun testMapHeaderOverlayRendersWithTitle() {
        ...
        composeTestRule.onNodeWithTag("map-header-overlay").assertIsDisplayed()
        composeTestRule.onNodeWithText("Test Title").assertIsDisplayed()
    }

    @Test
    fun testMapHeaderOverlayRendersLeftAction() {
        var leftActionPressed = false
        composeTestRule.setContent {
            CompositionLocalProvider(LocalLaneShadowTheme provides testTheme) {
                MapHeaderOverlay(
                    title = "Test Title",
                    leftAction = Action(
                        icon = "menu",
                        onPress = { leftActionPressed = true },
                        testID = "left-action",
        ...
        composeTestRule.onNodeWithTag("left-action-left-button").assertIsDisplayed()
    }

    @Test
    fun testMapHeaderOverlayRendersRightAction() {
        composeTestRule.setContent {
            CompositionLocalProvider(LocalLaneShadowTheme provides testTheme) {
                MapHeaderOverlay(
                    title = "Test Title",
        ...
        composeTestRule.onNodeWithTag("right-action-right-button").assertIsDisplayed()
    }

    @Test
    fun testMapHeaderOverlayRendersBothActions() {
        composeTestRule.setContent {
            CompositionLocalProvider(LocalLaneShadowTheme provides testTheme) {
                MapHeaderOverlay(
                    title = "Test Title",
    ...
    @Test
    fun testMapHeaderOverlayRendersWithoutBackground() {
        composeTestRule.setContent {
            CompositionLocalProvider(LocalLaneShadowTheme provides testTheme) {
                MapHeaderOverlay(
                    title = "Test Title",
