...
/**
 * TDD tests for ErrorToast component
 *
...
class ErrorToastTest {
    ...
    /**
     * AC-1: ErrorToast renders with title, description, and close button
     *
     * GIVEN: ErrorToast with title, description, and showCloseButton=true
     * WHEN: Composed
     * THEN: Displays title, description, close icon, and error icon
     */
    @Test
    fun test_rendersWithTitleDescriptionAndCloseButton() {
        ...
        composeTestRule.onNodeWithText("Error Title")
            .assertIsDisplayed()

        // Verify description is displayed
        composeTestRule.onNodeWithText("Error description text")
            .assertIsDisplayed()

        // Verify close button exists and is clickable
        composeTestRule.onNodeWithContentDescription("Close error toast")
            .assertExists()
            .performClick()
    ...
    /**
     * AC-2: ErrorToast hides close button when showCloseButton=false
     *
     * GIVEN: ErrorToast with showCloseButton=false
     * WHEN: Composed
    ...
    /**
     * AC-3: ErrorToast has proper accessibility description
     *
     * GIVEN: ErrorToast with title and description
     * WHEN: Composed
    ...
    /**
     * AC-4: ErrorToast uses theme tokens for styling
     *
     * GIVEN: ErrorToast composed with test theme
     * WHEN: Rendered
     * THEN: Uses danger color for background, onPrimary for text, lg radius, level4 elevation
     */
    @Test
    fun test_usesThemeTokens() {
        ...
        composeTestRule.onNodeWithText("Styled Error")
            .assertIsDisplayed()
