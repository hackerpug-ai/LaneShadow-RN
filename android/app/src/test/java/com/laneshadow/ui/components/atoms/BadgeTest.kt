...
class BadgeTest {
    ...
    // Create a minimal test theme (Badge doesn't use domain colors)
     ...
     */
    @Test
    fun testBadgeDefaultRendering() {
        // GIVEN: Badge component with default props
        // WHEN: Rendered with text
        ...
        // THEN: Component displays with text
     ...
     */
    @Test
    fun testBadgeStylePropertiesMatchMatrix() {
        // Test default variant (primary background, onPrimary text)
        composeTestRule.setContent {
            CompositionLocalProvider(LocalLaneShadowTheme provides testTheme) {
                Badge(
        ...
        // Test outline variant (transparent background, border)
        composeTestRule.setContent {
            CompositionLocalProvider(LocalLaneShadowTheme provides testTheme) {
                Badge(
    ...
    fun testBadgeStates() {
        ...
        composeTestRule.onNodeWithText("Faded").assertIsDisplayed()

        // Test with both icon and opacity
        composeTestRule.setContent {
            CompositionLocalProvider(LocalLaneShadowTheme provides testTheme) {
                Badge(
                    text = "Complex",
    ...
    /**
     * Placeholder icon composable for testing
     */
    @Composable
