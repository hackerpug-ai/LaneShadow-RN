...
// Use public Mapbox styles for the live iOS runtime. The generated LaneShadow
// Studio style tokens currently resolve to unavailable styles on physical
// devices, which leaves the interactive map blank after auth.
let lsMapLightStyleURI = "mapbox://styles/mapbox/light-v11"
let lsMapDarkStyleURI = "mapbox://styles/mapbox/dark-v11"
