...
import type { MapLatLng } from '../../../shared/lib/polyline'
import { decodePolylineGeometry } from '../../../shared/lib/polyline'
import type { PolylineGeometry } from '../../../shared/models/saved-routes'
...
export const RouteMiniMap = ({
  ...
  return (
    <View style={styles.container} pointerEvents="none" testID={testID}>
      ...
      >
        <Mapbox.Camera centerCoordinate={center} zoomLevel={zoom} />
        <Mapbox.ShapeSource id="mini-map-route" shape={feature}>
          <Mapbox.LineLayer
